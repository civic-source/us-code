---
title: "Section 3305 - Simplified procedures for small purchases"
usc_title: 41
usc_section: "3305"
chapter: 33
...
- **(c)** A proposed purchase or contract for an amount above the simplified acquisition threshold may not be divided into several purchases or contracts for lesser amounts to use the simplified procedures required by subsection (a).
- **(d)** In using the simplified procedures, an executive agency shall promote competition to the maximum extent practicable.
- **(e)** An executive agency shall comply with the Federal Acquisition Regulation provisions referred to in section 1901(e) of this title .
