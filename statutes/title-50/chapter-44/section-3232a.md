---
title: "Section 3232a - Measures to mitigate counterintelligence threats from proliferation and use of foreign commercial spyware"
usc_title: 50
usc_section: "3232a"
chapter: 44
...
- **(a)** In this section:
  ...
  - **(2)** The term “covered entity” means any foreign company that either directly or indirectly develops, maintains, owns, operates, brokers, markets, sells, leases, licenses, or otherwise makes available spyware.
  - **(3)** The term “foreign commercial spyware” means spyware that is developed (solely or in partnership with a foreign company), maintained, sold, leased, licensed, marketed, sourced (in whole or in part), or otherwise provided, either directly or indirectly, by a foreign company.
  - **(4)** The term “foreign company” means a company that is incorporated or domiciled outside of the United States, including any subsidiaries or affiliates wherever such subsidiaries or affiliates are domiciled or incorporated.
  - **(5)** The term “spyware” means a tool or set of tools that operate as an end-to-end system of software to provide an unauthorized user remote access to information stored on or transiting through an electronic device connected to the Internet and not owned or operated by the unauthorized user, including end-to-end systems that—
...
- **(c)**
  ...
  - **(2)**
    - **(A)** The Director of National Intelligence may prohibit any element of the intelligence community from entering into any contract or other agreement for any purpose with a company that has acquired, in whole or in part, any foreign commercial spyware.
    - **(B)** In considering whether and how to exercise the authority under subparagraph (A), the Director of National Intelligence shall consider—
  ...
  - **(4)**
    - **(A)** The head of an element of the intelligence community may request from the Director of National Intelligence the waiver of a prohibition made under paragraph (1) or (2).
