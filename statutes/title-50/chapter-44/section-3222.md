---
title: "Section 3222 - Program on recruitment and training"
usc_title: 50
usc_section: "3222"
chapter: 44
...
- **(a)**
  ...
  - **(2)** An individual selected for participation in the program shall commit to employment with an element of the intelligence community for a period that the Director determines is commensurate with the amount of funding provided to the individual under the program and under such terms and conditions as the Director considers appropriate.
  - **(3)** The program shall be known as the Pat Roberts Intelligence Scholars Program.
  - **(4)** The Director, in consultation with the heads of the elements of the intelligence community, shall maintain a publicly available internet website on the program that describes—
...
- **(b)** In carrying out the program under subsection (a), the Director shall—
...
- **(c)** Funds made available for the program under subsection (a) shall be used—
