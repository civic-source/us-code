---
title: "Section 3352f - Information-sharing program for positions of trust and security clearances"
usc_title: 50
usc_section: "3352f"
chapter: 45
...
- **(a)**
  ...
  - **(2)** The program established under paragraph (1) shall be known as the “Trusted Information Provider Program” (in this section referred to as the “Program”).
...
- **(e)**
  - **(1)** Not later than 90 days after December 20, 2019 , the Security Executive Agent and the Suitability and Credentialing Executive Agent shall jointly submit to the appropriate congressional committees and make available to appropriate industry partners a plan for the implementation of the Program.
