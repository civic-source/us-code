---
title: "Section 3370a - Biennial report on foreign investment risks"
usc_title: 50
usc_section: "3370a"
chapter: 45
...
- **(a)**
  - **(1)** The Director of National Intelligence shall establish an intelligence community interagency working group to prepare the biennial reports required by subsection (b).
...
- **(b)**
  ...
  - **(2)** Each report required by paragraph (1) shall include identification, analysis, and explanation of the following:
