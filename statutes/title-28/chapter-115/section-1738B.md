---
title: "Section 1738B - Full faith and credit for child support orders"
usc_title: 28
usc_section: "1738B"
chapter: 115
...
- **(g)** A court of a State that no longer has continuing, exclusive jurisdiction of a child support order may enforce the order with respect to nonmodifiable obligations and unsatisfied obligations that accrued before the date on which a modification of the order is made under subsections (e) and (f).
- **(h)**
  - **(1)** In a proceeding to establish, modify, or enforce a child support order, the forum State’s law shall apply except as provided in paragraphs (2) and (3).
