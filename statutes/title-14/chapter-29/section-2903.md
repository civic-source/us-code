---
title: "Section 2903 - Major acquisitions"
usc_title: 14
usc_section: "2903"
chapter: 29
...
- **(f)**
  - **(1)** Not later than 15 days after the end of each fiscal year quarter, the Commandant of the Coast Guard shall submit to the committees of Congress specified in subsection (a) an update setting forth a current assessment of the risks associated with all current major acquisition programs.
  - **(2)** Each update under this subsection shall set forth, for each current major acquisition program, the following:
...
- **(g)** In this section, the term “major acquisition program” means an ongoing acquisition undertaken by the Coast Guard with a life-cycle cost estimate greater than or equal to $300,000,000.
