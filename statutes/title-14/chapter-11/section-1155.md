---
title: "Section 1155 - Contract termination"
usc_title: 14
usc_section: "1155"
chapter: 11
...
- **(a)**
  - **(1)** Before terminating a procurement or acquisition contract with a total value of more than $1,000,000, the Commandant of the Coast Guard shall notify each vendor under such contract and require the vendor to maintain all work product related to the contract until the earlier of—
...
- **(b)** In this section the term “work product”—
...
- **(c)** A vendor that fails to maintain work product as required under subsection (a) is liable to the United States for a civil penalty of not more than $25,000 for each day on which such work product is unavailable.
- **(d)**
  ...
  - **(2)** The Commandant is not required to provide a report under paragraph (1) for any fiscal year for which there is no responsive information as described in subparagraphs (A) through (E) of paragraph (1).
