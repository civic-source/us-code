---
title: "Section 12119 - Owners engaged primarily in leasing or financing transactions"
usc_title: 46
usc_section: "12119"
chapter: 121
current_through: "PL 119-4"
classification: "46 U.S.C. § 12119"
generated_at: "2026-03-29T20:01:44.443Z"
---

# § 12119. Owners engaged primarily in leasing or financing transactions

- **(a)** In this section:
  - **(1)** The term “affiliate” means, with respect to any person, any other person that is—
  ...
  - **(3)** The term “oil” has the meaning given that term in section 2101(26) of this title .
  ...
  - **(6)** The term “United States affiliate” means, with respect to any person, an affiliate the principal place of business of which is located in the United States.
- **(b)** A coastwise endorsement may be issued for a vessel if—
...
- **(c)**
  - **(1)** A person meets the requirements of this subsection if the person transmits to the Secretary each year the certification required by paragraph (2) or (3) with respect to a vessel.
  - **(2)** To meet the certification requirement of this paragraph, a person shall certify that it—
  ...
  - **(3)**
    - **(A)** To meet the certification requirement of this paragraph, a person shall certify that—
...
- **(d)** The demise charter and any amendments to the charter shall be filed with the certification required by subsection (b)(3) or within 10 days after filing an amendment to the charter. The charter and amendments shall be made available to the public.
- **(e)** When a charter required by subsection (b)(3) is terminated for default by the charterer, the Secretary may continue the coastwise endorsement for not more than 6 months on terms and conditions the Secretary may prescribe.
- **(f)** A vessel satisfying the requirements of this section is deemed to be owned only by citizens of the United States under sections 12103 and 50501 of this title.
