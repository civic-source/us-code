---
title: "Section 4712 - Inventory of abandoned vessels"
usc_title: 46
usc_section: "4712"
chapter: 47
current_through: "PL 119-73"
classification: "46 U.S.C. § 4712"
...
- **(b)** The inventory established and maintained under subsection (a) shall include data on each vessel, including geographic information system data related to the location of each such vessel.
- **(c)** The Commandant shall make the inventory established under subsection (a) publicly available on a website of the Coast Guard.
- **(d)** In carrying out this section, the Commandant shall develop a process by which—
...
- **(e)** Except in a response action carried out under section 311(j) of the Federal Water Pollution Control Act ( 33 U.S.C. 1321 ) or in the case of imminent threat to life and safety, the Commandant shall not be responsible for removing any covered vessels listed on the inventory established and maintained under subsection (a).
