---
title: "Section 24a - Swap data repositories"
usc_title: 7
usc_section: "24a"
chapter: 1
current_through: "PL 116-72"
classification: "7 U.S.C. § 24a"
generated_at: "2026-03-30T08:48:40.251Z"
status: "active"
---
...
- **(a)**
  - **(1)**
    - **(A)** It shall be unlawful for any person, unless registered with the Commission, directly or indirectly to make use of the mails or any means or instrumentality of interstate commerce to perform the functions of a swap data repository.
    - **(B)** A derivatives clearing organization may register as a swap data repository.
  - **(2)** Each registered swap data repository shall be subject to inspection and examination by any representative of the Commission.
  - **(3)**
    - **(A)** To be registered, and maintain registration, as a swap data repository, the swap data repository shall comply with—
    ...
    - **(B)** Unless otherwise determined by the Commission by rule or regulation, a swap data repository described in subparagraph (A) shall have reasonable discretion in establishing the manner in which the swap data repository complies with the core principles described in this section.
- **(b)**
  - **(1)**
    - **(A)** In accordance with subparagraph (B), the Commission shall prescribe standards that specify the data elements for each swap that shall be collected and maintained by each registered swap data repository.
    - **(B)** In carrying out subparagraph (A), the Commission shall prescribe consistent data element standards applicable to registered entities and reporting counterparties.
  - **(2)** The Commission shall prescribe data collection and data maintenance standards for swap data repositories.
  - **(3)** The standards prescribed by the Commission under this subsection shall be comparable to the data standards imposed by the Commission on derivatives clearing organizations in connection with their clearing of swaps.
- **(c)** A swap data repository shall—
...
- **(e)**
  ...
  - **(3)**
    - **(A)** In accordance with rules prescribed by the Commission, the chief compliance officer shall annually prepare and sign a report that contains a description of—
    ...
    - **(B)** A compliance report under subparagraph (A) shall—
...
- **(f)**
  - **(1)** Unless necessary or appropriate to achieve the purposes of this chapter, a swap data repository shall not—
  ...
  - **(2)** Each swap data repository shall establish governance arrangements that are transparent—
  ...
  - **(3)** Each swap data repository shall—
  ...
  - **(4)**
    ...
    - **(B)** In developing additional duties under subparagraph (A), the Commission may take into consideration any evolving standard of the United States or the international community.
    - **(C)** The Commission shall establish additional duties for any registrant described in section 1a(48) of this title in order to minimize conflicts of interest, protect data, ensure compliance, and guarantee the safety and security of the swap data repository.
- **(g)** Any person that is required to be registered as a swap data repository under this section shall register with the Commission regardless of whether that person is also licensed as a bank or registered with the Securities and Exchange Commission as a swap data repository.
- **(h)** The Commission shall adopt rules governing persons that are registered under this section.
