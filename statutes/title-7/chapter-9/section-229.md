---
title: "Section 229 - Annual report"
usc_title: 7
usc_section: "229"
chapter: 9
...
- **(a)** Not later than March 1 of each year, the Secretary shall submit to Congress and make publicly available a report that—
...
- **(b)** For subparagraphs (C), (E), (F), and (H) of subsection (a)(1), the Secretary may, if appropriate due to the number of complaints for a given category, provide summary statistics (including range, maximum, minimum, mean, and average times) and graphical representations.
