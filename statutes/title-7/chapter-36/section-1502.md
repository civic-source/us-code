...
generated_at: "2026-03-30T04:15:50.044Z"
status: "active"
---
...
- **(b)** As used in this subchapter:
  ...
  - **(7)** The term “farm financial benchmarking” means—
  ...
  - **(8)** The term “loss ratio” means the ratio of all sums paid by the Corporation as indemnities under any eligible crop insurance policy to that portion of the premium designated for anticipated losses and a reasonable reserve, other than that portion of the premium designated for operating and administrative expenses.
  - **(9)** The term “organic crop” means an agricultural commodity that is organically produced consistent with section 6502 of this title .
  - **(10)** The term “Secretary” means the Secretary of Agriculture.
  - **(11)** The term “transitional yield” means the maximum average production per acre or equivalent measure that is assigned to acreage for a crop year by the Corporation in accordance with the regulations of the Corporation whenever the producer fails—
