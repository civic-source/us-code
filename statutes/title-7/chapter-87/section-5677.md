...
- **(d)** For each suspension of exports for which a program is implemented under this section, funds shall be made available under subsection (b) of this section for each fiscal year or part of a fiscal year for which the suspension is in effect, but not to exceed 3 fiscal years.
