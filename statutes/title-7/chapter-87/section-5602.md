...
As used in this chapter—
  ...
  - **(5)**
    - **(A)** Subject to subparagraph (B), the term “unfair trade practice” means any act, policy, or practice of a foreign country that—
      ...
      - **(iv)** imposes an unfair technical barrier to trade, including—
        ...
        - **(II)** an unjustified sanitary or phytosanitary restriction (including any restriction that, in violation of the Uruguay Round Agreements, is not based on scientific principles; 1 1 So in original. There probably should be a closing parenthesis.
