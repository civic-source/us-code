---
title: "Section 3 - Community Connect Grant Program"
usc_title: 7
usc_section: "3"
chapter: 31
current_through: "PL 116-16"
classification: "7 U.S.C. § 3"
generated_at: "2026-03-30T07:55:30.822Z"
status: "active"
---
...
- **(a)** In this section:
  ...
  - **(3)**
    - **(A)** The term “eligible entity” means a legally organized entity that—
      - **(i)** is—
...
- **(d)**
  - **(1)** An eligible entity that receives a grant under the Program may use the grant for—
  ...
  - **(3)** Of the amounts provided to an eligible entity under a grant under the Program, the eligible entity shall use to carry out paragraph (1)(B) not greater than the lesser of—
    ...
    - **(B)** $150,000.
- **(e)**
  - **(1)** An eligible entity that receives a grant under the Program shall provide a cash contribution in an amount that is not less than 15 percent of the amount of the grant.
...
- **(f)**
  - **(1)** To be eligible to receive a grant under the Program, an eligible entity shall submit to the Secretary an application at such time, in such manner, and containing such information as the Secretary may require.
