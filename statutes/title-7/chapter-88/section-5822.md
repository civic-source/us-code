...
- **(c)** To be eligible to participate in the program established by this section, a producer must—
...
- **(d)** In accepting contracts for the program, the Secretary, to the extent practicable, shall enroll not less than 3,000,000, nor more than 5,000,000, acres of cropland in each of the calendar years 1991 through 1995.
- **(e)** The Secretary shall enter into contracts with producers to enroll acreage in the program. Such contracts shall be for a period of not less than 3 years, but may, at the producer’s option, be for a longer period of time (up to 5 years) and may be renewed upon mutual agreement between the Secretary and the producer.
- **(f)** Each plan approved by the Secretary shall—
...
- **(h)**
  ...
  - **(7)**
    ...
    - **(B)**
      ...
      - **(ii)** In the case of a producer participating in a particular year in a program authorized under section 101B(c)(1)(D), 103B(c)(1)(D), 105B(c)(1)(E), or 107B(c)(1)(E) 1 1 See References in Text note below. of the Agricultural Act of 1949, the term “traditionally underplanted acreage” means 8 percent of the producer’s permitted acreage for such year.
