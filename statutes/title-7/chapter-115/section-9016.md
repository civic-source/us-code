...
- **(a)** If all of the producers on a farm make the election under subsection (a) or (h) of section 9015 of this title to obtain price loss coverage or, subject to subsection (c)(1) of such section, are deemed to have made such election under subsection (c)(2) of such section, the Secretary shall make price loss coverage payments to producers on the farm on a covered commodity-by-covered-commodity basis if the Secretary determines that—
