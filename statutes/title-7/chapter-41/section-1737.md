---
title: "Section 1737 - John Ogonowski and Doug Bereuter Farmer-to-Farmer Program"
usc_title: 7
usc_section: "1737"
chapter: 41
...
- **(a)** In this section:
  - **(1)** The term “Caribbean Basin country” means a country eligible for designation as a beneficiary country under section 2702 of title 19 .
  - **(2)** The term “emerging market” means a country that the Secretary determines—
  ...
  - **(3)** The term “middle income country” means a country that has developed economically to the point at which the country does not receive bilateral development assistance from the United States.
  - **(4)** The term “sub-Saharan African country” has the meaning given the term in section 3706 of title 19 .
- **(b)** Notwithstanding section 1342 of title 31 or any other provision of law, to further assist developing countries, middle-income countries, emerging markets, sub-Saharan African countries, and Caribbean Basin countries to increase farm production and farmer incomes, the President may—
  ...
  - **(2)** use United States agricultural producers, agriculturalists, colleges and universities (including historically black colleges and universities, land grant colleges or universities, and foundations maintained by colleges or universities), private agribusinesses, private organizations (including grassroots organizations with an established and demonstrated capacity to carry out such a bilateral exchange program), private corporations, employees or staff of a State cooperative institution (as such term is defined in paragraph 18 of section 3103 of this title , except that subparagraphs (E), (F), and (G) of such paragraph shall not apply), and nonprofit farm organizations to work in conjunction with agricultural producers and farm organizations in those countries, on a voluntary basis—
    - **(A)** to improve agricultural and agribusiness operations and agricultural systems in those countries, including improving—
      ...
      - **(vi)** farm credit;
      - **(vii)** marketing;
      - **(viii)** inputs 1 1 So in original. Probably should be followed by a semicolon.
...
- **(c)**
  ...
  - **(2)** The goals of programs carried out under this section in sub-Saharan African and Caribbean Basin countries shall be—
...
- **(e)**
  - **(1)** There are authorized to be appropriated for each of fiscal years 2008 through 2023 to carry out the programs under this section—
...
- **(f)**
  - **(1)** The Administrator of the Agency for International Development shall develop a grant program to be carried out in fiscal years 2019 through 2023 to facilitate new and innovative partnerships and activities under this subchapter.
  - **(2)** A grant recipient under this subsection shall use funds received under this subsection to—
