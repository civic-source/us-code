  ...
  (1) 
    (A) 
      ...
      (ii) The Secretary shall set the tolerance level for excluding small errors for the purposes of this subsection—
        ...
        (II) for each fiscal year thereafter, the amount specified in subclause (I) adjusted by the percentage by which the thrifty food plan is adjusted under section 2012(u)(3) of this title between June 30, 2013 , and June 30 of the immediately preceding fiscal year.
    (B) 
