---
title: "Section 473 - Grants for improvements to meat and poultry facilities to allow for interstate shipment"
usc_title: 21
usc_section: "473"
chapter: 10
current_through: "PL 117-32"
classification: "21 U.S.C. § 473"
generated_at: "2026-03-29T21:01:15.185Z"
---
...
- **(b)** To be eligible for a grant under this section, a meat or poultry slaughter or processing facility shall be—
...
- **(c)** A facility that receives a grant under this section may use the grant amount for—
...
- **(d)**
  - **(1)** The amount of a grant under this section shall not exceed $200,000.
  - **(2)** As a condition of receiving a grant under this section, a grant recipient shall agree that the grant recipient shall make a payment (or payments) to the Secretary in an amount equal to the amount of the grant if the recipient, within 36 months of receiving such grant—
    - **(A)** as applicable—
...
- **(f)** Of the funds of the Treasury not otherwise appropriated, there is appropriated to carry out this section $60,000,000 for the period of fiscal years 2021 through 2023, to remain available until expended.
