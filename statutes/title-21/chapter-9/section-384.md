...
- **(d)**
  - **(1)** The regulations under subsection (b) shall require an importer of a prescription drug under subsection (b) to submit to the Secretary the following information and documentation:
...
- **(e)** The regulations under subsection (b) shall require—
