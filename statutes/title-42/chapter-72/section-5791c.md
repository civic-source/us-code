...
- **(c)** The Federal share of the cost of any activities funded by a grant under the program under subsection (a) may not exceed 50 percent.
- **(d)** The Attorney General shall, to the maximum extent practicable, ensure the distribution of grants under the program under subsection (a) on an equitable basis throughout the various regions of the United States.
- **(e)** The Attorney General shall prescribe requirements, including application requirements, for grants under the program under subsection (a).
- **(f)**
