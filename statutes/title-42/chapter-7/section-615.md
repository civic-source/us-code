...
- **(b)**
  - **(1)** A State may terminate a waiver described in subsection (a) before the expiration of the waiver.
  ...
  - **(3)**
    - **(A)** Notwithstanding any other provision of law, a State that, not later than the date described in subparagraph (B) of this paragraph, submits a written request to terminate a waiver described in subsection (a) shall be held harmless for accrued cost neutrality liabilities incurred under the waiver.
