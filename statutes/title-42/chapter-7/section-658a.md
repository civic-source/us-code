---
title: "Section 658a - Incentive payments to States"
usc_title: 42
usc_section: "658a"
chapter: 7
current_through: "PL 118-44"
classification: "42 U.S.C. § 658a"
generated_at: "2026-03-30T00:54:16.155Z"
---
...
- **(b)**
  ...
  - **(2)**
    - **(A)** In paragraph (1), the term “incentive payment pool” means—
  ...
  - **(5)**
    - **(A)** For purposes of paragraph (4), the maximum incentive base amount for a State for a fiscal year is—
  ...
  - **(6)**
    ...
    - **(B)**
      - **(i)** The support order performance level for a State for a fiscal year is the percentage of the total number of cases under the State plan approved under this part in which there is a support order during the fiscal year.
    ...
    - **(E)**
      - **(i)** The cost-effectiveness performance level for a State for a fiscal year is equal to the total amount collected during the fiscal year under the State plan approved under this part divided by the total amount expended during the fiscal year under the State plan, expressed as a ratio.
      - **(ii)** The applicable percentage with respect to a State’s cost-effectiveness performance level is as follows: If the cost-effectiveness performance level is: The applicable percentage is: At least: But less than: 5.00 100 4.50 4.99 90 4.00 4.50 80 3.50 4.00 70 3.00 3.50 60 2.50 3.00 50 2.00 2.50 40 0.00 2.00 0.
