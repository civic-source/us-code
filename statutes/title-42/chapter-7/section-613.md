---
title: "Section 613 - Research, evaluations, and national studies"
usc_title: 42
usc_section: "613"
chapter: 7
...
- **(e)**
  - **(1)** The Secretary shall annually rank States to which grants are made under section 603 of this title based on the following ranking factors:
    ...
    - **(B)** The difference between the ratio described in subparagraph (A) with respect to a State for the most recent year for which such information is available and the ratio with respect to the State for the immediately preceding year.
  - **(2)** The Secretary shall review the programs of the 5 States most recently ranked highest under paragraph (1) and the 5 States most recently ranked the lowest under paragraph (1).
- **(f)** A State shall be eligible to receive funding to evaluate the State program funded under this part if—
...
- **(g)**
  ...
  - **(2)** The matters described in this paragraph are the following:
...
- **(h)**
  ...
  - **(3)** The Secretary may implement and evaluate demonstrations of innovative and promising strategies which—
...
- **(i)**
  - **(1)** Not later than May 31, 1998 , and annually thereafter, the chief executive officer of each State shall submit to the Secretary a statement of the child poverty rate in the State as of August 22, 1996 , or the date of the most recent prior statement under this paragraph.
  ...
  - **(3)** A corrective action plan submitted under paragraph (2) shall outline the manner in which the State will reduce the child poverty rate in the State. The plan shall include a description of the actions to be taken by the State under such plan.
...
- **(j)**
  - **(1)** The Secretary, in consultation with the Secretary of Labor and the Secretary of Housing and Urban Development—
  ...
  - **(2)**
    - **(A)** Subject to subparagraphs (B) and (C), the Secretary, in consultation with the Secretary of Labor and the Secretary of Housing and Urban Development, shall submit to the Congress reports on the projects funded under section 1 1 So in original. Probably should be “sections”. 603(a)(5) and 612(a)(3) of this title and on the evaluations of the projects.
    - **(B)** Not later than January 1, 1999 , the Secretary shall submit an interim report on the matter described in subparagraph (A).
    - **(C)** Not later than January 1, 2001 , 2 2 So in original. (or at a later date, if the Secretary informs the Committees of the Congress with jurisdiction over the subject matter of the report) the Secretary shall submit a final report on the matter described in subparagraph (A).
