---
title: "Section 9628 - State response programs"
usc_title: 42
usc_section: "9628"
chapter: 103
current_through: "PL 117-26"
classification: "42 U.S.C. § 9628"
generated_at: "2026-03-29T20:40:42.922Z"
---
...
- **(a)**
  - **(1)**
    - **(A)** The Administrator may award a grant to a State or Indian tribe that—
...
- **(b)**
  - **(1)**
    ...
    - **(B)** The President may bring an administrative or judicial enforcement action under this chapter during or after completion of a response action described in subparagraph (A) with respect to a release or threatened release at an eligible response site described in that subparagraph if—
    ...
    - **(D)**
      ...
      - **(iii)** The Administrator may take action immediately after giving notification under clause (i) without waiting for a State reply under clause (ii) if the Administrator determines that one or more exceptions under subparagraph (B) are met.
  ...
  - **(2)**
    - **(A)** Nothing in paragraph (1) precludes the President from seeking to recover costs incurred prior to January 11, 2002 , or during a period in which the limitations of paragraph (1)(A) were not applicable.
  ...
  - **(3)** This subsection applies only to response actions conducted after February 15, 2001 .
- **(c)** Nothing in this section affects any liability or response authority under any Federal law, including—
