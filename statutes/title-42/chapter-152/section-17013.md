---
title: "Section 17013 - Advanced technology vehicles manufacturing incentive program"
usc_title: 42
usc_section: "17013"
chapter: 152
current_through: "PL 113-103"
classification: "42 U.S.C. § 17013"
generated_at: "2026-03-30T03:46:13.854Z"
status: "active"
---
...
- **(a)** In this section:
  - **(1)** The term “advanced technology vehicle” means an ultra efficient vehicle or a light duty vehicle that meets—
  ...
  - **(2)** The term “combined fuel economy” means—
  ...
  - **(3)** The term “engineering integration costs” includes the cost of engineering tasks relating to—
  ...
  - **(5)** The term “ultra efficient vehicle” means a fully closed compartment vehicle designed to carry at least 2 adult passengers that achieves—
...
- **(b)** The Secretary shall provide facility funding awards under this section to automobile manufacturers, ultra efficient vehicle manufacturers, and component suppliers to pay not more than 30 percent of the cost of—
...
- **(c)** An award under subsection (b) shall apply to—
...
- **(d)**
  ...
  - **(3)** The Secretary shall select eligible projects to receive loans under this subsection in cases in which, as determined by the Secretary, the award recipient—
  ...
  - **(4)** A loan provided under this subsection—
    ...
    - **(B)** shall have a term equal to the lesser of—
      - **(i)** the projected life, in years, of the eligible project to be carried out using funds from the loan, as determined by the Secretary; and 1 1 So in original. Probably should be “or”.
      - **(ii)** 25 years;
...
- **(f)** Administrative costs shall be no more than $100,000 or 10 basis point 2 2 So in original. Probably should be “points”. of the loan.
...
- **(h)**
  - **(1)** In this subsection, the term “covered firm” means a firm that—
...
- **(i)** There are authorized to be appropriated such sums as are necessary to carry out this section for each of fiscal years 2008 through 2012.
- **(j)**
