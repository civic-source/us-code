---
title: "Section 17233 - Energy storage technology and microgrid assistance program"
usc_title: 42
usc_section: "17233"
chapter: 152
current_through: "PL 117-159"
classification: "42 U.S.C. § 17233"
generated_at: "2026-03-29T23:07:11.935Z"
---
...
- **(a)** In this section:
  ...
  - **(2)** The term “energy storage technology” includes grid-enabled water heaters, building heating or cooling systems, electric vehicles, the production of hydrogen for transportation or industrial use, or other technologies that store energy.
  - **(3)** The term “microgrid” means a localized grid that operates autonomously regardless of whether the grid can operate in connection with another grid.
  - **(4)** The term “renewable energy source” has the meaning given the term in section 918c(a) of title 7 .
  - **(5)** The term “rural electric cooperative” means an electric cooperative (as defined in section 796 of title 16 ) that sells electric energy to persons in rural areas.
...
- **(d)**
  ...
  - **(3)** An eligible entity that receives a grant under paragraph (1)—
  ...
  - **(4)** As a condition of receiving a grant under paragraph (1), an eligible entity shall—
  ...
  - **(5)** Activities under this subsection shall be subject to the cost-sharing requirements of section 16352 of this title .
- **(e)**
...
- **(f)**
  - **(1)** There is authorized to be appropriated to carry out this section $15,000,000 for each of fiscal years 2021 through 2025.
  - **(2)** Not more than 5 percent of the amount appropriated under paragraph (1) for each fiscal year shall be used for administrative expenses.
