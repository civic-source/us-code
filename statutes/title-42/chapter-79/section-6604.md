---
title: "Section 6604 - Interagency working group on research regulation"
usc_title: 42
usc_section: "6604"
chapter: 79
current_through: "PL 118-82"
classification: "42 U.S.C. § 6604"
generated_at: "2026-03-30T01:40:53.697Z"
---

# § 6604. Interagency working group on research regulation

- **(a)** This section may be cited as the “Research and Development Efficiency Act”.
...
- **(e)**
  ...
  - **(2)**
    ...
    - **(B)** In developing the uniform grant format, the Working Group shall consider whether to implement—
  ...
  - **(3)**
    - **(A)** The Working Group shall establish, to the extent practicable, a secure, centralized database for investigator biosketches, curriculum vitae, licenses, lists of publications, and other documents considered relevant by the Working Group.
    - **(B)** In establishing the centralized profile database under subparagraph (A), the Working Group shall consider incorporating existing investigator databases.
    - **(C)** To the extent practicable, all grant proposals shall utilize the centralized investigator profile database established under subparagraph (A).
    - **(D)** Each investigator shall—
  ...
  - **(5)**
    ...
    - **(B)** In developing the strategy, the Working Group shall consider limiting progress reports to performance outcomes.
- **(f)** In carrying out its responsibilities under subsection (e)(1), the Working Group shall consult with academic researchers outside the Federal Government, including—
