...
- **(a)**
  ...
  - **(2)**
    - **(A)** After making the initial allotments described in paragraph (1), the Assistant Secretary shall adjust the allotments on a pro rata basis in accordance with subparagraphs (B) and (C).
    - **(B)**
