...
- **(c)**
  - **(1)** A grant under this section shall be made for a period of not more than 2 years.
  - **(2)** The amount of a grant under this section may not exceed $1,000,000.
  - **(3)** The Federal share of a grant under this section may not exceed 50 percent of the total costs of the project described in the application submitted under subsection (d) for the fiscal year for which the grant was made under this section.
- **(d)**
...
- **(e)**
  ...
  - **(2)** The Attorney General shall ensure that each report submitted under paragraph (1) is made available under the national clearinghouse established under section 15604 of this title .
- **(f)** In this section, the term “State” includes the District of Columbia, the Commonwealth of Puerto Rico, and any other territory or possession of the United States.
- **(g)**
  - **(1)** There are authorized to be appropriated for grants under this section $40,000,000 for each of fiscal years 2004 through 2010.
  - **(2)** Of amounts made available for grants under this section, not less than 50 percent shall be available only for activities specified in paragraph (1) of subsection (b).
