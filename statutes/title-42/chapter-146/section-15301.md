---
title: "Section 15301 - Payments to States for activities to improve administration of elections"
usc_title: 42
usc_section: "15301"
chapter: 146
...
- **(b)**
  - **(1)** A State shall use the funds provided under a payment made under this section to carry out one or more of the following activities:
  ...
  - **(2)** A State may not use the funds provided under a payment made under this section—
...
- **(c)** In order to receive a payment under the program under this section, the State shall provide the Administrator with certifications that—
...
- **(d)**
  - **(1)** Subject to section 15303(b) of this title , the amount of payment made to a State under this section shall be the minimum payment amount described in paragraph (2) plus the voting age population proportion amount described in paragraph (3).
  - **(2)** The minimum payment amount described in this paragraph is—
  ...
  - **(3)** The voting age population proportion amount described in this paragraph is the product of—
  ...
  - **(4)** The term “voting age population proportion” means, with respect to a State, the amount equal to the quotient of—
