---
title: "Section 6249c - Contracts for which implementing legislation is needed"
usc_title: 42
usc_section: "6249c"
chapter: 77
...
- **(b)** The Secretary shall consult, at the earliest possible time and on a continuing basis, with each committee of the House and the Senate that has jurisdiction over all matters expected to be affected by legislation needed to implement any such contract.
- **(c)** Each contract and each amendment to a contract for which an implementing bill is necessary may become effective only if—
...
- **(d)** Subsections (e) through (h) of this section are enacted by the Congress—
...
- **(e)**
  ...
  - **(2)** If the Senate is not in session on the day on which such an agreement is submitted, the implementing bill shall be introduced in the Senate, as provided in the 1 1 So in original. The word “the” probably should not appear. paragraph (1), on the first day thereafter on which the Senate is in session.
