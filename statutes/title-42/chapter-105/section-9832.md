...
For purposes of this subchapter:
  ...
  - **(4)** The term “family literacy services” means services that are of sufficient intensity in terms of hours, and of sufficient duration, to make sustainable changes in a family, and that integrate all of the following activities:
    ...
    - **(C)** Parent literacy training that leads to economic self-sufficiency, and financial literacy.. 1 1 So in original.
  ...
  - **(19)** The term “poverty line” means the official poverty line (as defined by the Office of Management and Budget)—
    - **(A)** adjusted to reflect the percentage change in the Consumer Price Index For 2 2 So in original. Probably should not be capitalized. All Urban Consumers, issued by the Bureau of Labor Statistics, occurring in the 1-year period or other interval immediately preceding the date such adjustment is made; and
