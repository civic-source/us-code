...
- **(b)**
  - **(1)** From the amounts appropriated under section 9859a of this title for each fiscal year and remaining after reservations are made under subsection (a), the Secretary shall allot to each State an amount equal to the sum of—
...
- **(c)** The Secretary shall obtain from each appropriate Federal agency, the most recent data and information necessary to determine the allotments provided for in subsection (b).
