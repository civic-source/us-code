---
title: "Section 18743 - Critical minerals mining and recycling research"
usc_title: 42
usc_section: "18743"
chapter: 162
current_through: "PL 119-73"
classification: "42 U.S.C. § 18743"
generated_at: "2026-03-29T02:15:37.459Z"
---

# § 18743. Critical minerals mining and recycling research

- **(a)** In this section:
  - **(1)** The term “critical mineral” has the meaning given the term in section 1606(a) of title 30 .
  - **(2)** The term “critical minerals and metals” includes any host mineral of a critical mineral.
  - **(3)** The term “Director” means the Director of the Foundation.
  - **(4)** The term “end-to-end”, with respect to the integration of mining or life cycle of minerals, means the integrated approach of, or the lifecycle determined by, examining the research and developmental process from the mining of the raw minerals to its processing into useful materials, its integration into components and devices, the utilization of such devices in the end-use application to satisfy certain performance metrics, and the recycling or disposal of such devices.
  ...
  - **(6)** The term “Foundation” means the National Science Foundation.
  - **(7)** The term “institution of higher education” has the meaning given the term in section 1001 of title 20 .
  - **(8)** The term “National Laboratory” has the meaning given the term in section 15801 of this title .
  - **(9)** The term “recycling” means the process of collecting and processing spent materials and devices and turning the materials and devices into raw materials or components that can be reused either partially or completely.
...
- **(b)**
  ...
  - **(2)** Entities eligible to receive an award under paragraph (1) are the following:
  ...
  - **(3)** Activities funded by an award under this section may include—
...
- **(c)**
  ...
  - **(3)** In carrying out paragraphs (1) and (2), the Subcommittee may, taking into account the findings and recommendations of relevant advisory committees—
  ...
  - **(4)** In carrying out paragraphs (1) and (2), the Subcommittee shall, taking into account the findings and recommendations of relevant advisory committees, identify and evaluate Federal policies and regulations that restrict the mining of critical minerals.
- **(d)**
  - **(1)** The Secretary, in consultation with the Director, the Secretary of the Interior, and the Secretary of Commerce, shall establish a grant program to finance pilot projects for—
    - **(A)** the processing or recycling of critical minerals in the United States; or
    - **(B)** the development of critical minerals and metals in the United States 3 3 So in original. Probably should be followed by a period.
  - **(2)** A grant awarded under paragraph (1) may not exceed $10,000,000.
  - **(3)** In awarding grants under paragraph (1), the Secretary shall give priority to projects that the Secretary determines are likely to be economically viable over the long term.
  - **(4)** In awarding grants under paragraph (1), the Secretary shall seek to award not less than 30 percent of the total amount of grants awarded during the fiscal year for projects relating to secondary recovery of critical minerals and metals.
  - **(5)** In awarding grants for the development of critical minerals and metals under paragraph (1)(B), the Secretary shall prioritize pilot projects that will process the critical minerals and metals domestically.
  - **(6)** In awarding grants under paragraph (1), the Secretary shall ensure that pilot projects do not export for processing any critical minerals and metals to a foreign entity of concern.
