...
- **(a)**
  ...
  - **(2)**
    ...
    - **(D)** Bi-level dining cars shall not be required to—
      ...
      - **(iv)** have a restroom usable by an individual who uses a wheelchair.
  - **(3)**
    - **(A)** It shall be considered discrimination for purposes of section 12132 of this title and section 794 of title 29 for a person who provides intercity rail transportation to fail to have on each train which includes one or more single-level rail passenger coaches—
  ...
  - **(4)**
    - **(A)** On any train in which a single-level dining car is used to provide food service—
...
- **(e)**
  ...
  - **(2)**
    - **(A)**
      ...
      - **(ii)**
        - **(I)** All stations in the intercity rail transportation system shall be made readily accessible to and usable by individuals with disabilities, including individuals who use wheelchairs, as soon as practicable, but in no event later than 20 years after July 26, 1990 .
