---
title: "Section 19084 - Advanced computing"
usc_title: 42
usc_section: "19084"
chapter: 163
...
- **(d)**
  ...
  - **(2)**
    ...
    - **(C)**
      - **(i)** In selecting universities pursuant to subparagraph (B), the Director shall give preference to institutions of higher education with the capability of serving other regional universities.
    ...
    - **(G)**
      - **(i)** The Director shall report to Congress not later than 6 months after the completion of the pilot program under subparagraph (A).
