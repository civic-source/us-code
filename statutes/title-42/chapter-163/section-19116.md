---
title: "Section 19116 - Authorities"
usc_title: 42
usc_section: "19116"
chapter: 163
current_through: "PL 119-73"
classification: "42 U.S.C. § 19116"
generated_at: "2026-03-29T20:07:45.044Z"
---
...
In addition to existing authorities available to the Foundation, the Director may exercise the following authorities in carrying out the activities under this part:
  ...
  - **(1)** In carrying out this part, the Director may provide awards in the form of grants, contracts, cooperative agreements, cash prizes, and other transactions.
  - **(2)**
    - **(A)** The Director may designate individuals to serve as program directors for the programs established within the Directorate pursuant to the responsibilities established under subparagraph (B). The Director shall ensure that program directors—
    ...
    - **(B)** A program director of a program of the Directorate, in consultation with the Assistant Director, shall be responsible for—
    ...
    - **(C)** Program directors may use diverse merit review models for selection of award recipients under section 19114 of this title , including internal review and different models that use peer review.
    - **(D)** Program directors of the Directorate may be appointed by the Director for a limited term, renewable at the discretion of the Director.
  - **(3)**
    - **(A)** The Foundation may carry out a program of personnel management authority provided under subparagraph (B) in order to facilitate recruitment of eminent experts in science or engineering for research and development projects and to enhance the administration and management of the Foundation.
    - **(B)** Under the program under subparagraph (A), the Foundation may—
    ...
    - **(C)**
      - **(i)** Except as provided in clause (ii), the service of an employee under an appointment under subparagraph (B)(i) may not exceed 4 years.
      - **(ii)** The Director may, in the case of a particular employee under the program under subparagraph (A), extend the period to which service is limited under clause (i) by up to 2 years if the Director determines that such action is necessary to promote the efficiency of the Foundation.
    - **(D)** Notwithstanding any other provision of this subsection or section 5307 of title 5 , no additional payments may be paid to an employee under subparagraph (B)(iii) in any calendar year if, or to the extent that, the employee’s total annual compensation in such calendar year will exceed the maximum amount of total annual compensation payable at the salary set in accordance with section 104 of title 3 .
  - **(4)**
    ...
    - **(B)** Under the program, the Foundation may—
    ...
    - **(C)**
      - **(i)** Except as provided in clause (ii), the service of an employee under an appointment made pursuant to this subsection may not exceed 5 years.
      - **(ii)** The Foundation may, in the case of a particular employee, extend the period to which service is limited under clause (i) by up to 1 additional year if the Foundation determines that such action is necessary to promote the Foundation’s national security missions.
    - **(D)**
      - **(i)** The total amount of the additional payments paid to an employee under this subsection for any 12-month period may not exceed the maximum amount of total compensation payable at the salary set in accordance with section 104 of title. 2 2 So in original. Probably should be “ section 104 of title 3 ”.
      - **(ii)** An employee appointed under this subsection is not eligible for any bonus, monetary award, or other monetary incentive for service, except for payments authorized under this subsection.
    - **(E)** The number of highly qualified experts appointed and retained by the Foundation under sub 3 3 So in original. Probably should be “subparagraph”. (B)(i) shall not exceed 70 at any time.
    - **(F)** In the event that the Foundation terminates the program under this paragraph, in the case of an employee who, on the day before the termination of the program, is serving in a position pursuant to an appointment under this paragraph—
  ...
  - **(6)**
    ...
    - **(B)** Upon completion of the study under subparagraph (A), the Foundation shall review the recommendations from the National Academy of Public Administration and provide a briefing to Congress on the plans of the Foundation to implement any such recommendations.
