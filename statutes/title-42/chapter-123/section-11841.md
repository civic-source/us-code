...
generated_at: "2026-03-30T00:12:27.696Z"
---
...
- **(c)**
  - **(1)** Each State that submits for a fiscal year an application under subsection (b) that meets the requirements of the Secretary shall, subject to the availability of appropriations, receive a grant in an amount determined in accordance with paragraph (3).
  ...
  - **(3)**
    - **(A)** Of the aggregate amount appropriated under subsection (g) for any fiscal year and after reserving the amount required by paragraph (2), the Secretary shall—
      - **(i)** allot—
