---
title: "Section 13122 - Authority and functions"
usc_title: 5
usc_section: "13122"
chapter: 131
...
- **(a)** The Director shall provide, in consultation with the Office of Personnel Management, overall direction of executive branch policies related to preventing conflicts of interest on the part of officers and employees of any executive agency, as defined in section 105 of this title .
...
- **(c)** In the development of policies, rules, regulations, procedures, and forms to be recommended, authorized, or prescribed by the Director, the Director shall consult when appropriate with the executive agencies affected and with the Attorney General.
- **(d)**
...
- **(f)**
  ...
  - **(2)**
    ...
    - **(B)**
      ...
      - **(ii)**
        ...
        - **(II)** The Director shall, in accordance with section 553 of this title , establish procedures for such notification and comment.
      ...
      - **(iv)** The procedures described in clauses (ii) and (iii) of this subparagraph do not apply to findings or orders for action made to obtain compliance with the financial disclosure requirements in subchapter I. For those findings and orders, the procedures in section 13108 of this title shall apply.
  ...
  - **(5)** Nothing in this subchapter shall be considered to allow the Director (or any designee) to make any finding that a provision of title 18, or any criminal law of the United States outside of title 18, has been or is being violated.
