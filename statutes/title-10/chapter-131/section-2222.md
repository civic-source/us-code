...
generated_at: "2026-03-30T05:11:54.704Z"
status: "active"
---
...
- **(d)** The guidance issued under subsection (c)(1) shall include the following elements:
  - **(1)** Policy to ensure that the business processes of the Department of Defense are continuously reviewed and revised—
    ...
    - **(B)** eliminate 1 1 So in original. Probably should be preceded by “to”. or reduce the need to tailor commercial off-the-shelf systems to meet or incorporate requirements or interfaces that are unique to the Department of Defense.
...
- **(g)**
  - **(1)** The Secretary shall ensure that a covered defense business system program cannot proceed into development (or, if no development is required, into production or fielding) unless the appropriate approval official (as specified in paragraph (2)) determines that—
    ...
    - **(E)** is 2 2 So in original. Probably should be preceded by “the system”. in compliance with the Department’s auditability requirements.
...
- **(i)** In this section:
  ...
  - **(5)** The term “priority defense business system” 3 means a defense business system that is—
