---
title: "Section 385 - Department of Defense support for other departments and agencies of the United States Government that advance Department of Defense security cooperation objectives"
usc_title: 10
usc_section: "385"
chapter: 16
...
- **(d)** If a determination is made to transfer funds in connection with the provision of support pursuant to subsection (a) for a program or activity, the transfer may not occur until—
  - **(1)** the Secretary and the head of the department or agency to receive the funds jointly submit to the congressional defense committees a notice on the transfer, which notice shall include—
    ...
    - **(B)** a detailed description of the security cooperation objectives of the Department, include 1 1 So in original. Probably should be “including”. the theater campaign plan of the combatant command concerned, that will be advanced;
