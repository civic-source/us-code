...
- **(b)** In this section:
  ...
  - **(3)** The term “involuntarily board-separated” means separated or retired from an armed force, or transferred to the Retired Reserve or to inactive status in a reserve component, or the Space Force,, 2 2 So in original. as a result of a recommendation of a selection board.
- **(c)**
