---
title: "Section 1415 - Lump sum payment of certain retired pay"
usc_title: 10
usc_section: "1415"
chapter: 71
current_through: "PL 114-254"
classification: "10 U.S.C. § 1415"
generated_at: "2026-03-29T18:23:51.820Z"
---

# § 1415. Lump sum payment of certain retired pay

- **(a)** In this section:
  - **(1)** The term “covered retired pay” means retired pay under—
    - **(A)** this title;
    - **(B)** title 14;
  ...
  - **(2)** The term “eligible person” means a person who—
    - **(A)**
  ...
  - **(3)** The term “retirement age” has the meaning given the term in section 216( l ) of the Social Security Act ( 42 U.S.C. 416 ( l )).
- **(b)**
  - **(1)** An eligible person entitled to covered retired pay (including an eligible person who is entitled to such pay by reason of an election described in subsection (a)(2)(A)(ii)) may elect to receive—
    ...
    - **(B)** a monthly amount during the period described in subparagraph (A) equal to—
      ...
      - **(ii)** in the case of an eligible person electing to receive an amount described in subparagraph (A)(ii), 75 percent of the amount of monthly covered retired pay the eligible person is otherwise entitled to receive during such period 1 1 So in original. Probably should be followed by a period.
  - **(2)** The Secretary of Defense shall compute the discounted present value of amounts of covered retired pay that an eligible person is otherwise entitled to receive for a period for purposes of paragraph (1)(A) by—
  ...
  - **(3)** An eligible person shall make the election under this subsection not later than 90 days before the date of the retirement of the eligible person from the uniformed services.
  - **(4)** An eligible person may elect to receive a lump sum payment under this subsection in a single payment or in a combination of payments.
  - **(5)** An eligible person who makes an election under this subsection shall receive the lump sum payment, or the first installment of a combination of payments of the lump sum payment if elected under paragraph (4), as follows:
...
- **(e)** The Secretary of Defense concerned 2 2 So in original. shall prescribe regulations to carry out the provisions of this section.
