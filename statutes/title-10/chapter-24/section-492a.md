---
title: "Section 492a - Annual report on the plan for the nuclear weapons stockpile, nuclear weapons complex, nuclear weapons delivery systems, and nuclear weapons command and control system"
usc_title: 10
usc_section: "492a"
chapter: 24
current_through: "PL 117-200"
classification: "10 U.S.C. § 492a"
generated_at: "2026-03-29T18:47:53.252Z"
---
...
- **(a)**
  ...
  - **(3)** Each budget estimate under paragraph (2)(F) shall include a detailed description of the costs included in such estimate and the methodology used to create such estimate.
  - **(4)**
    ...
    - **(B)** In no case may the President transmit a report required by paragraph (1) for a fiscal year to the committees specified in that paragraph later than 60 days after the submission to Congress of the budget of the President for that fiscal year.
- **(b)**
  - **(1)** Not later than July 1 of each year in which the President transmits a covered odd-numbered fiscal year report, the Director of the Congressional Budget Office shall submit to the congressional defense committees a report that includes—
