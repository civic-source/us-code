---
title: "Section 2305a - Design-build selection procedures"
usc_title: 10
usc_section: "2305a"
chapter: 137
...
- **(d)** A solicitation issued pursuant to the procedures described in subsection (c) shall state the maximum number of offerors that are to be selected to submit competitive proposals pursuant to subsection (c)(4). The maximum number specified in the solicitation shall not exceed 5 unless the agency determines with respect to an individual solicitation that a specified number greater than 5 is in the Government’s interest and is consistent with the purposes and objectives of the two-phase selection process.
