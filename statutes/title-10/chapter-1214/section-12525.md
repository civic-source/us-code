---
title: "Section 12525 - Benefit amounts"
usc_title: 10
usc_section: "12525"
chapter: 1214
...
- **(a)** The basic benefit for an insured member under the insurance program is $1,000 per month (as adjusted under subsection (d)).
- **(b)** Under the regulations prescribed by the Secretary, a person enrolled for coverage under the insurance program may elect—
...
- **(c)** The amount of insurance payable to an insured member for any period of covered service that is less than one month shall be determined by multiplying 1 ⁄ 30 of the monthly benefit rate for the member by the number of days of the covered service served by the member during such period.
- **(d)**
