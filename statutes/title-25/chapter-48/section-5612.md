---
title: "Section 5612 - Establishment of demonstration project; selection of participating Indian tribes"
usc_title: 25
usc_section: "5612"
chapter: 48
...
- **(a)** The Secretary shall establish and carry out an Indian trust asset management demonstration project, in accordance with this subchapter.
- **(b)**
  - **(1)** An Indian tribe shall be eligible to participate in the project if—
  ...
  - **(2)**
    - **(A)** The Secretary shall provide a written notice to each Indian tribe approved to participate in the project.
    - **(B)** A notice under subparagraph (A) shall include—
...
- **(c)**
  - **(1)** To be eligible to participate in the project, an Indian tribe shall submit to the Secretary a written application in accordance with paragraph (2).
  - **(2)** The Secretary shall consider an application under this subsection only if the application—
