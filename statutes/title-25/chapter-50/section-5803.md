---
title: "Section 5803 - Establishment of program"
usc_title: 25
usc_section: "5803"
chapter: 50
...
(b) 
  ...
  (2) 
    (A) Two or more entities may submit a joint application for a project that combines the resources and expertise of those entities at a physical location dedicated to assisting Native businesses and Native entrepreneurs under the program.
    (B) A joint application submitted under subparagraph (A) shall—
...
(c) 
  (1) Each eligible applicant desiring a grant under the program shall submit to the Secretary an application at such time, in such manner, and containing such information as the Secretary may require, including—
  ...
  (2) 
    (A) In evaluating each application, the Secretary shall consider—
    ...
    (B) 
      (i) In evaluating the proposed location of the business incubator under subparagraph (A)(iii), the Secretary shall—
      ...
      (ii) The Secretary may give priority to an eligible applicant that is not located on or near the reservation of the 1 or more communities that were described in the application if the Secretary determines that—
  ...
  (3) 
    (A) Before making a grant to an eligible applicant, the Secretary shall conduct a site visit, evaluate a video submission, or evaluate a written site proposal (if the applicant is not yet in possession of the site) of the proposed site to ensure the proposed site will permit the eligible applicant to meet the requirements of the program.
    (B) A written site proposal shall meet the requirements described in paragraph (1)(E) and contain—
    ...
    (C) Not later than 1 year after awarding a grant to an eligible applicant that submits an application with a written site proposal, the Secretary shall conduct a site visit or evaluate a video submission of the site to ensure the site is consistent with the written site proposal.
(d) 
  (1) Each grant awarded under the program shall be for a term of 3 years.
  (2) 
    (A) Except as provided in subparagraph (B), the Secretary shall disburse grant funds awarded to an eligible applicant in annual installments.
    (B) On request by the applicant, the Secretary may make disbursements of grant funds more frequently than annually, on the condition that disbursements shall be made not more frequently than quarterly.
  (3) 
    (A) Except as provided in subparagraph (B), an eligible applicant that receives a grant under the program shall provide non-Federal contributions in an amount equal to not less than 25 percent of the grant amount disbursed each year.
    (B) The Secretary may waive, in whole or in part, the requirements of subparagraph (A) with respect to an eligible applicant if, after considering the ability of the eligible applicant to provide non-Federal contributions, the Secretary determines that—
  ...
  (4) 
    (A) The Secretary may renew a grant award under the program for a term not to exceed 3 years.
    (B) In determining whether to renew a grant award, the Secretary shall consider with respect to the eligible applicant—
    ...
    (C) An eligible applicant that receives a grant renewal under subparagraph (A) shall provide non-Federal contributions in an amount equal to not less than 33 percent of the total amount of the grant.
  (5) An eligible applicant shall not be awarded a grant under the program that is duplicative of existing Federal funding from another source.
(e) 
  (1) An eligible applicant receiving a grant under the program may use grant amounts—
  ...
  (2) Each eligible applicant receiving a grant under the program shall—
  ...
  (3) Each eligible applicant shall leverage technology to the maximum extent practicable to provide Native businesses and Native entrepreneurs with access to the connectivity tools needed to compete and thrive in 21st-century markets.
(f) 
  (1) Not later than 1 year after the date on which the Secretary awards a grant to an eligible applicant under the program, and annually thereafter for the duration of the grant, the Secretary shall conduct an evaluation of, and prepare a report on, the eligible applicant, which shall—
  ...
  (2) 
    ...
    (C) To the maximum extent practicable, the Secretary shall not require an eligible applicant to report under subparagraph (A) information provided to the Secretary by the eligible applicant under other programs.
