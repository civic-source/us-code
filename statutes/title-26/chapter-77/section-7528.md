---
title: "Section 7528 - Internal Revenue Service user fees"
usc_title: 26
usc_section: "7528"
chapter: 77
...
- **(a)** The Secretary shall establish a program requiring the payment of user fees for—
  - **(1)** requests to the Internal Revenue Service for ruling letters, opinion letters, and determination letters, and
  - **(2)** other similar requests.
- **(b)**
  - **(1)** The fees charged under the program required by subsection (a)—
  ...
  - **(2)**
    - **(A)** The Secretary shall provide for such exemptions (and reduced fees) under such program as the Secretary determines to be appropriate.
    - **(B)** The Secretary shall not require payment of user fees under such program for requests for determination letters with respect to the qualified status of a pension benefit plan maintained solely by 1 or more eligible employers or any trust which is part of the plan. The preceding sentence shall not apply to any request—
    ...
    - **(C)** For purposes of subparagraph (B)—
      - **(i)** The term “pension benefit plan” means a pension, profit-sharing, stock bonus, annuity, or employee stock ownership plan.
