...
- **(b)**
  ...
  - **(3)**
    - **(A)** The Secretary shall publish guidance as appropriate to define and implement any waiver of the signature requirements or any method adopted under paragraph (1).
