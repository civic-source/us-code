---
title: "Section 6041 - Information at source"
usc_title: 26
usc_section: "6041"
chapter: 61
...
- **(d)** Every person required to make a return under subsection (a) shall furnish to each person with respect to whom such a return is required a written statement showing—
...
- **(e)** This section shall not apply to tips with respect to which section 6053(a) (relating to reporting of tips) applies.
- **(f)** This section shall not apply to any payment for medical care (as defined in section 213(d)) made under—
...
- **(h)** In the case of any calendar year after 2026, the dollar amount in subsection (a) shall be increased by an amount equal to—
