...
generated_at: "2026-03-29T21:34:40.144Z"
---
...
- **(b)**
  ...
  - **(6)**
    ...
    - **(B)** Subparagraph (A) shall not apply to any expenditure to liquidate any contract entered into (or for any amount otherwise obligated) before November 1, 2021 , in accordance with the provisions of this section.
- **(c)**
...
- **(f)**
  ...
  - **(11)** Any amount appropriated or transferred under this subsection to the Highway Trust Fund shall remain available without fiscal year limitation.
