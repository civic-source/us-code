...
- **(b)**
  ...
  - **(6)**
    ...
    - **(B)** Subparagraph (A) shall not apply to any expenditure to liquidate any contract entered into (or for any amount otherwise obligated) before August 1, 2015 , in accordance with the provisions of this section.
- **(c)**
...
- **(f)**
  ...
  - **(7)** Any amount appropriated or transferred under this subsection to the Highway Trust Fund shall remain available without fiscal year limitation.
