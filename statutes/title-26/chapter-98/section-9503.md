...
- **(b)**
  ...
  - **(6)**
    ...
    - **(B)** Subparagraph (A) shall not apply to any expenditure to liquidate any contract entered into (or for any amount otherwise obligated) before December 4, 2021 , in accordance with the provisions of this section.
- **(c)**
