---
title: "Section 9511 - Patient-Centered Outcomes Research Trust Fund"
usc_title: 26
usc_section: "9511"
chapter: 98
...
- **(b)**
  - **(1)** There are hereby appropriated to the Trust Fund the following:
  ...
  - **(2)** In addition to the amounts appropriated under paragraph (1), there shall be credited to the PCORTF the amounts transferred under section 1183 of the Social Security Act.
  - **(3)** No amount may be appropriated or transferred to the PCORTF on and after the date of any expenditure from the PCORTF which is not an expenditure permitted under this section. The determination of whether an expenditure is so permitted shall be made without regard to—
  ...
  - **(4)** In paragraph (1)(F)(ii), the term “applicable amount” means—
...
- **(c)** The Secretary of the Treasury shall be a trustee of the PCORTF.
- **(d)**
  - **(1)** Subject to paragraph (2), amounts in the PCORTF are available, without further appropriation, to the Patient-Centered Outcomes Research Institute established under section 1181(b) of the Social Security Act for carrying out part D of title XI of the Social Security Act (as in effect on the date of enactment of such Act).
  - **(2)**
    - **(A)** The trustee of the PCORTF shall provide for the transfer from the PCORTF of 20 percent of the amounts appropriated or credited to the PCORTF for each of fiscal years 2011 through 2029 to the Secretary of Health and Human Services to carry out section 937 of the Public Health Service Act.
    - **(B)** Amounts transferred under subparagraph (A) shall remain available until expended.
    - **(C)** Of the amounts transferred under subparagraph (A) with respect to a fiscal year, the Secretary of Health and Human Services shall distribute—
...
- **(f)** No amounts shall be available for expenditure from the PCORTF after September 30, 2029 , and any amounts in such Trust Fund after such date shall be transferred to the general fund of the Treasury.
