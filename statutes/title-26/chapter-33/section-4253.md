...
- **(l)**
  - **(1)** In order to claim an exemption under subsection (c), (h), (i), (j), or (k), a person shall provide to the provider of communications services a statement (in such form and manner as the Secretary may provide) certifying that such person is entitled to such exemption.
