---
title: "Section 7612 - Special procedures for summonses for computer software"
usc_title: 26
usc_section: "7612"
chapter: 78
current_through: "PL 119-18"
classification: "26 U.S.C. § 7612"
generated_at: "2026-03-30T02:22:26.118Z"
---
...
- **(b)**
  - **(1)** Subsection (a)(1) shall not apply to any portion, item, or component of tax-related computer software source code if—
  ...
  - **(2)** Subsection (a)(1) shall not apply to—
  ...
  - **(3)** For purposes of paragraph (1), the Secretary shall be treated as meeting the requirements of subparagraphs (A) and (B) of such paragraph if—
  ...
  - **(4)** In any proceeding brought under section 7604 to enforce a summons issued under the authority of this subsection, the court shall, at the request of any party, hold a hearing to determine whether the applicable requirements of this subsection have been met.
- **(c)**
...
- **(d)** For purposes of this section—
  - **(1)** The term “software” includes computer software source code and computer software executable code.
  - **(2)** The term “computer software source code” means—
  ...
  - **(3)** The term “computer software executable code” means—
  ...
  - **(4)** The term “owner” shall, with respect to any software, include the developer of the software.
  - **(5)** A person shall be treated as related to another person if such persons are related persons under section 267 or 707(b).
  - **(6)** The term “tax-related computer software source code” means the computer source code for any computer software program intended for accounting, tax return preparation or compliance, or tax planning.
