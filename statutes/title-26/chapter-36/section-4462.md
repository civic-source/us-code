---
title: "Section 4462 - Definitions and special rules"
usc_title: 26
usc_section: "4462"
chapter: 36
current_through: "PL 116-220"
classification: "26 U.S.C. § 4462"
...
- **(a)** For purposes of this subchapter—
  ...
  - **(2)**
    - **(A)** The term “port” means any channel or harbor (or component thereof) in the United States, which—
  ...
  - **(3)**
    - **(A)** The term “commercial cargo” means any cargo transported on a commercial vessel, including passengers transported for compensation or hire.
  ...
  - **(4)**
    - **(A)** The term “commercial vessel” means any vessel used—
    ...
    - **(B)**
      - **(i)** The term “commercial vessel” does not include any ferry engaged primarily in the ferrying of passengers (including their vehicles) between points within the United States, or between the United States and contiguous countries.
  ...
  - **(5)**
    - **(A)** The term “value” means, except as provided in regulations, the value of any commercial cargo as determined by standard commercial documentation.
...
- **(b)**
  - **(1)** No tax shall be imposed under section 4461(a) with respect to—
