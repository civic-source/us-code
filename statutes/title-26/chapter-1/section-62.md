---
title: "Section 62 - Adjusted gross income defined"
usc_title: 26
usc_section: "62"
chapter: 1
current_through: "PL 113-100"
classification: "26 U.S.C. § 62"
generated_at: "2026-03-29T18:05:44.459Z"
---

# § 62. Adjusted gross income defined

- **(a)** For purposes of this subtitle, the term “adjusted gross income” means, in the case of an individual, gross income minus the following deductions:
  - **(1)** The deductions allowed by this chapter (other than by part VII of this subchapter) which are attributable to a trade or business carried on by the taxpayer, if such trade or business does not consist of the performance of services by the taxpayer as an employee.
  - **(2)**
  ...
  - **(5)** In the case of a life tenant of property, or an income beneficiary of property held in trust, or an heir, legatee, or devisee of an estate, the deduction for depreciation allowed by section 167 and the deduction allowed by section 611.
  - **(6)** In the case of an individual who is an employee within the meaning of section 401(c)(1), the deduction allowed by section 404.
...
- **(b)**
  ...
  - **(2)** An individual shall not be treated as performing services in the performing arts as an employee for any employer during any taxable year unless the amount received by such individual from such employer for the performance of such services during the taxable year equals or exceeds $200.
  - **(3)**
    - **(A)** Except in the case of a husband and wife who lived apart at all times during the taxable year, if the taxpayer is married at the close of the taxable year, subsection (a)(2)(B) shall apply only if the taxpayer and his spouse file a joint return for the taxable year.
    - **(B)** In the case of a joint return—
    ...
    - **(C)** For purposes of this subsection, marital status shall be determined under section 7703(a).
    - **(D)** For purposes of this subsection, the term “joint return” means the joint return of a husband and wife made under section 6013.
- **(c)** For purposes of subsection (a)(2)(A), an arrangement shall in no event be treated as a reimbursement or other expense allowance arrangement if—
