---
title: "Section 55 - Alternative minimum tax imposed"
usc_title: 26
usc_section: "55"
chapter: 1
current_through: "PL 113-47"
classification: "26 U.S.C. § 55"
generated_at: "2026-03-30T03:23:39.279Z"
status: "active"
---
...
- **(b)** For purposes of this part—
  - **(1)**
    - **(A)**
      - **(i)** In the case of a taxpayer other than a corporation, the tentative minimum tax for the taxable year is the sum of—
      ...
      - **(ii)** For purposes of this subsection, the term “taxable excess” means so much of the alternative minimum taxable income for the taxable year as exceeds the exemption amount.
      - **(iii)** In the case of a married individual filing a separate return, clause (i) shall be applied by substituting 50 percent of the dollar amount otherwise applicable under subclause (I) and subclause (II) thereof. For purposes of the preceding sentence, marital status shall be determined under section 7703.
    - **(B)** In the case of a corporation, the tentative minimum tax for the taxable year is—
  ...
  - **(3)** The amount determined under the first sentence of paragraph (1)(A)(i) shall not exceed the sum of—
...
- **(d)** For purposes of this section—
  - **(1)** In the case of a taxpayer other than a corporation, the term “exemption amount” means—
  ...
  - **(2)** In the case of a corporation, the term “exemption amount” means $40,000.
  - **(3)** The exemption amount of any taxpayer shall be reduced (but not below zero) by an amount equal to 25 percent of the amount by which the alternative minimum taxable income of the taxpayer exceeds—
  ...
  - **(4)**
    - **(A)** In the case of any taxable year beginning in a calendar year after 2012, the amounts described in subparagraph (B) shall each be increased by an amount equal to—
...
- **(e)**
  - **(1)**
    ...
    - **(B)** Subparagraph (A) shall be applied by substituting “$5,000,000” for “$7,500,000” for the first 3-taxable-year period (or portion thereof) of the corporation which is taken into account under subparagraph (A).
    - **(C)** If such taxable year is the first taxable year that such corporation is in existence, the tentative minimum tax of such corporation for such year shall be zero.
    - **(D)** For purposes of this paragraph, the rules of paragraphs (2) and (3) of section 448(c) shall apply.
  - **(2)** In the case of a corporation whose tentative minimum tax is zero for any prior taxable year by reason of paragraph (1), the application of this part for taxable years beginning with the first taxable year such corporation ceases to be described in paragraph (1) shall be determined with the following modifications:
  ...
  - **(3)** The modifications in paragraph (2) shall not apply to—
  ...
  - **(4)** For purposes of paragraph (2), the change date is the first day of the first taxable year for which the taxpayer ceases to be described in paragraph (1).
  - **(5)** In the case of a taxpayer whose tentative minimum tax for any taxable year is zero by reason of paragraph (1), section 53(c) shall be applied for such year by reducing the amount otherwise taken into account under section 53(c)(1) by 25 percent of so much of such amount as exceeds $25,000. Rules similar to the rules of section 38(c)(6)(B) shall apply for purposes of the preceding sentence.
