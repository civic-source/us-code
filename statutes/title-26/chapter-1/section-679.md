---
title: "Section 679 - Foreign trusts having one or more United States beneficiaries"
usc_title: 26
usc_section: "679"
chapter: 1
...
- **(a)**
  ...
  - **(3)**
    - **(A)** In determining whether paragraph (2)(B) applies to any transfer by a person described in clause (ii) or (iii) of subparagraph (C), there shall not be taken into account—
...
- **(c)**
  - **(1)** For purposes of this section, a trust shall be treated as having a United States beneficiary for the taxable year unless—
