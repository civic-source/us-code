---
title: "Section 45C - Clinical testing expenses for certain drugs for rare diseases or conditions"
usc_title: 26
usc_section: "45C"
chapter: 1
...
- **(b)** For purposes of this section—
  - **(1)**
    ...
    - **(B)** For purposes of subparagraph (A), subsection (b) of section 41 shall be applied—
    ...
    - **(D)** If section 41 is not in effect for any period, such section shall be deemed to remain in effect for such period for purposes of this paragraph.
  - **(2)**
...
- **(c)**
  - **(1)** Except as provided in paragraph (2), any qualified clinical testing expenses for a taxable year to which an election under this section applies shall not be taken into account for purposes of determining the credit allowable under section 41 for such taxable year.
  - **(2)** Any qualified clinical testing expenses for any taxable year which are qualified research expenses (within the meaning of section 41(b)) shall be taken into account in determining base period research expenses for purposes of applying section 41 to subsequent taxable years.
- **(d)**
