---
title: "Section 302 - Distributions in redemption of stock"
usc_title: 26
usc_section: "302"
chapter: 1
...
- **(b)**
  - **(1)** Subsection (a) shall apply if the redemption is not essentially equivalent to a dividend.
  - **(2)**
    - **(A)** Subsection (a) shall apply if the distribution is substantially disproportionate with respect to the shareholder.
...
- **(c)**
  - **(1)** Except as provided in paragraph (2) of this subsection, section 318(a) shall apply in determining the ownership of stock for purposes of this section.
  - **(2)**
    ...
    - **(C)**
      - **(i)** Subparagraph (A) shall not apply to a distribution to any entity unless—
...
- **(e)**
  - **(1)** For purposes of subsection (b)(4), a distribution shall be treated as in partial liquidation of a corporation if—
