---
title: "Section 470 - Limitation on deductions allocable to property used by governments or other tax-exempt entities"
usc_title: 26
usc_section: "470"
chapter: 1
current_through: "PL 117-227"
classification: "26 U.S.C. § 470"
generated_at: "2026-03-29T23:42:21.917Z"
---
...
- **(c)** For purposes of this section—
  ...
  - **(2)**
    - **(A)** The term “tax-exempt use property” has the meaning given to such term by section 168(h), except that such section shall be applied—
...
- **(d)** This section shall not apply to any lease of property which meets the requirements of all of the following paragraphs:
  - **(1)**
    - **(A)** A lease of property meets the requirements of this paragraph if (at all times during the lease term) not more than an allowable amount of funds are—
    ...
    - **(C)**
      - **(i)** Except as otherwise provided in this subparagraph, the term “allowable amount” means an amount equal to 20 percent of the lessor’s adjusted basis in the property at the time the lease is entered into.
  ...
  - **(2)**
    - **(A)** A lease of property meets the requirements of this paragraph if—
      - **(i)** the lessor—
...
- **(e)**
  - **(1)**
    - **(A)** In the case of any former tax-exempt use property—
  ...
  - **(4)**
    - **(A)** Sections 1031(a) and 1033(a) shall not apply if—
