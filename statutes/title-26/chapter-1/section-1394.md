---
title: "Section 1394 - Tax-exempt enterprise zone facility bonds"
usc_title: 26
usc_section: "1394"
chapter: 1
  ...
  - **(3)**
    ...
    - **(B)** In applying section 1397C for purposes of this section—
      - **(i)**
        ...
        - **(II)** For purposes of subsection (b)(6) and (c)(5) of section 1397C, an employee shall be treated as a resident of an empowerment zone if such employee is a resident of an empowerment zone, an enterprise community, or a qualified low-income community within an applicable nominating jurisdiction.
...
- **(d)** The requirements of sections 147(c)(1)(A) and 147(d) shall not apply to any bond described in subsection (a).
- **(e)**
  - **(1)** An issue which fails to meet 1 or more of the requirements of subsections (a) and (b) shall be treated as meeting such requirements if—
...
- **(f)**
  ...
  - **(2)**
    ...
    - **(C)**
      - **(i)** Bonds to which paragraph (1) applies shall not be taken into account in applying the limitation of subsection (c) to other bonds.
