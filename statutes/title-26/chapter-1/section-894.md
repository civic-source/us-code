---
title: "Section 894 - Income affected by treaty"
usc_title: 26
usc_section: "894"
chapter: 1
...
- **(a)**
  - **(1)** The provisions of this title shall be applied to any taxpayer with due regard to any treaty obligation of the United States which applies to such taxpayer.
...
- **(c)**
  - **(1)** A foreign person shall not be entitled under any income tax treaty of the United States with a foreign country to any reduced rate of any withholding tax imposed by this title on an item of income derived through an entity which is treated as a partnership (or is otherwise treated as fiscally transparent) for purposes of this title if—
