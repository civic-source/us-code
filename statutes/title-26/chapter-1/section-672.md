---
title: "Section 672 - Definitions and rules"
usc_title: 26
usc_section: "672"
chapter: 1
current_through: "PL 114-72"
classification: "26 U.S.C. § 672"
...
- **(e)**
  - **(1)** For purposes of this subpart, a grantor shall be treated as holding any power or interest held by—
...
- **(f)**
  - **(1)** Notwithstanding any other provision of this subpart, this subpart shall apply only to the extent such application results in an amount (if any) being currently taken into account (directly or through 1 or more entities) under this chapter in computing the income of a citizen or resident of the United States or a domestic corporation.
  - **(2)**
    - **(A)** Paragraph (1) shall not apply to any portion of a trust if—
