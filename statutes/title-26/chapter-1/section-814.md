---
title: "Section 814 - Contiguous country branches of domestic life insurance companies"
usc_title: 26
usc_section: "814"
chapter: 1
...
- **(a)** In the case of a domestic mutual insurance company which—
...
- **(b)** For purposes of this section, the term contiguous country life insurance branch means a branch which—
...
- **(e)**
  ...
  - **(2)**
    ...
    - **(B)** The addition provided by subparagraph (A) for the taxable year with respect to any contiguous country life insurance branch shall not exceed the amount by which—
