---
title: "Section 818 - Other definitions and special rules"
usc_title: 26
usc_section: "818"
chapter: 1
current_through: "PL 119-46"
classification: "26 U.S.C. § 818"
generated_at: "2026-03-30T02:45:23.062Z"
---

# § 818. Other definitions and special rules

- **(a)** For purposes of this part, the term “pension plan contract” means any contract—
...
- **(c)**
  - **(1)** In the case of property held by the taxpayer on December 31, 1958 , if—
  ...
  - **(2)** In the case of property acquired after December 31, 1958 , and having a substituted basis (within the meaning of section 1016(b))—
  ...
  - **(3)** For purposes of paragraphs (1) and (2), the term “property” does not include insurance and annuity contracts and property described in paragraph (1) of section 1221(a).
- **(d)** For purposes of this part, the term “insurance or annuity contract” includes any contract supplementary thereto.
- **(e)**
  - **(1)** If an election under section 1504(c)(2) is in effect with respect to an affiliated group for the taxable year, all items of the members of such group which are not life insurance companies shall not be taken into account in determining the amount of the tentative LICTI of members of such group which are life insurance companies.
  - **(2)** In the case of a life insurance company filing or required to file a consolidated return under section 1501 with respect to any affiliated group for any taxable year, any determination under this part with respect to any dividend paid by one member of such group to another member of such group shall be made as if such group was not filing a consolidated return.
- **(f)**
  ...
  - **(2)**
    - **(A)** On or before September 15, 1985 , any life insurance company may elect to treat items described in paragraph (1) as properly apportioned or allocated among items of gross income to the extent (and in the manner) prescribed in regulations.
    - **(B)** Any election under subparagraph (A), once made, may be revoked only with the consent of the Secretary.
  - **(3)** For purposes of part I of subchapter N, items described in any paragraph of section 807(c) shall be treated as amounts which are not interest.
- **(g)** For purposes of this part—
  - **(1)** Any reference to a life insurance contract shall be treated as including a reference to a qualified accelerated death benefit rider on such contract.
  - **(2)** For purposes of this subsection, the term “qualified accelerated death benefit rider” means any rider on a life insurance contract if the only payments under the rider are payments meeting the requirements of section 101(g).
  - **(3)** Paragraph (1) shall not apply to any rider which is treated as a long-term care insurance contract under section 7702B.
