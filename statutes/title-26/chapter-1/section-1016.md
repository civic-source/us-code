---
title: "Section 1016 - Adjustments to basis"
usc_title: 26
usc_section: "1016"
chapter: 1
...
- **(a)** Proper adjustment in respect of the property shall in all cases be made—
  ...
  - **(3)** in respect of any period—
    ...
    - **(D)** since February 28, 1913 , during which such property was held by a person subject to tax under part II 1 1 See References in Text note below. of subchapter L (or the corresponding provisions of prior income tax laws), to the extent that paragraph (2) does not apply,
...
- **(c)**
  ...
  - **(2)**
    - **(A)** In the case of any partial disposition for which an election under this subsection is made, the increase in basis under paragraph (1) shall be an amount—
    ...
    - **(B)** For purposes of subparagraph (A), the term “partial disposition” means any disposition or cessation to which subsection (c)(2)(D), (h)(1)(B), or (i)(1)(B) of section 2032A applies.
  - **(3)** Any increase in basis under this subsection shall be deemed to have occurred immediately before the disposition or cessation resulting in the imposition of the tax under section 2032A(c)(1).
  - **(4)** If the tax under section 2032A(c)(1) is imposed with respect to qualified replacement property (as defined in section 2032A(h)(3)(B)) or qualified exchange property (as defined in section 2032A(i)(3)), the increase in basis under paragraph (1) shall be made by reference to the property involuntarily converted or exchanged (as the case may be).
  - **(5)**
    - **(A)** An election under this subsection shall be made at such time and in such manner as the Secretary shall by regulations prescribe. Such an election, once made, shall be irrevocable.
    - **(B)** If an election is made under this subsection with respect to any additional estate tax imposed under section 2032A(c)(1), for purposes of section 6601 (relating to interest on underpayments), the last date prescribed for payment of such tax shall be deemed to be the last date prescribed for payment of the tax imposed by section 2001 with respect to the estate of the decedent (as determined for purposes of section 6601).
- **(d)** If—
...
- **(e)** For treatment of separate mineral interests as one property, see section 614.
