---
title: "Section 4980I - Excise tax on high cost employer-sponsored health coverage"
usc_title: 26
usc_section: "4980I"
chapter: 43
current_through: "PL 113-99"
classification: "26 U.S.C. § 4980I"
generated_at: "2026-03-30T03:38:36.138Z"
status: "active"
---
...
- **(b)** For purposes of this section—
  - **(1)** The term “excess benefit” means, with respect to any applicable employer-sponsored coverage made available by an employer to an employee during any taxable period, the sum of the excess amounts determined under paragraph (2) for months during the taxable period.
  - **(2)** The excess amount determined under this paragraph for any month is the excess (if any) of—
  ...
  - **(3)** For purposes of this subsection—
    - **(A)** The annual limitation under this paragraph for any calendar year is the dollar limit determined under subparagraph (C) for the calendar year.
    - **(B)**
      - **(i)** Except as provided in clause (ii), the annual limitation which applies for any month shall be determined on the basis of the type of coverage (as determined under subsection (f)(1)) provided to the employee by the employer as of the beginning of the month.
      - **(ii)** Any coverage provided under a multiemployer plan (as defined in section 414(f)) shall be treated as coverage other than self-only coverage.
    - **(C)**
      - **(i)** In the case of 2018, the dollar limit under this subparagraph is—
      ...
      - **(ii)** For purposes of clause (i), the health cost adjustment percentage is equal to 100 percent plus the excess (if any) of—
        ...
        - **(II)** 55 percent.
      - **(iii)**
        - **(I)** The amount determined under subclause (I) or (II) of clause (i), whichever is applicable, for any taxable period shall be increased by the amount determined under subclause (II).
...
- **(c)**
  ...
  - **(2)** For purposes of this subsection, the term “coverage provider” means each of the following:
    - **(A)** If the applicable employer-sponsored coverage consists of coverage under a group health plan which provides health insurance coverage, the health insurance issuer.
    - **(B)** If the applicable employer-sponsored coverage consists of coverage under an arrangement under which the employer makes contributions described in subsection (b) or (d) of section 106, the employer.
    - **(C)** In the case of any other applicable employer-sponsored coverage, the person that administers the plan benefits.
  - **(3)** For purposes of this subsection, a coverage provider’s applicable share of an excess benefit for any taxable period is the amount which bears the same ratio to the amount of such excess benefit as—
  ...
  - **(4)**
    ...
    - **(B)** In the case of applicable employer-sponsored coverage made available to employees through a multiemployer plan (as defined in section 414(f)), the plan sponsor shall make the calculations, and provide the notice, required under subparagraph (A).
- **(d)** For purposes of this section—
  - **(1)**
    ...
    - **(B)** The term “applicable employer-sponsored coverage” shall not include—
    ...
    - **(C)** Coverage shall be treated as applicable employer-sponsored coverage without regard to whether the employer or employee pays for the coverage.
    - **(D)** In the case of an individual who is an employee within the meaning of section 401(c)(1), coverage under any group health plan providing health insurance coverage shall be treated as applicable employer-sponsored coverage if a deduction is allowable under section 162( l ) with respect to all or any portion of the cost of the coverage.
    - **(E)** Applicable employer-sponsored coverage shall include coverage under any group health plan established and maintained primarily for its civilian employees by the Government of the United States, by the government of any State or political subdivision thereof, or by any agency or instrumentality of any such government.
  - **(2)**
    - **(A)** The cost of applicable employer-sponsored coverage shall be determined under rules similar to the rules of section 4980B(f)(4), except that in determining such cost, any portion of the cost of such coverage which is attributable to the tax imposed under this section shall not be taken into account and the amount of such cost shall be calculated separately for self-only coverage and other coverage. In the case of applicable employer-sponsored coverage which provides coverage to retired employees, the plan may elect to treat a retired employee who has not attained the age of 65 and a retired employee who has attained the age of 65 as similarly situated beneficiaries.
    - **(B)** In the case of applicable employer-sponsored coverage consisting of coverage under a flexible spending arrangement (as defined in section 106(c)(2)), the cost of the coverage shall be equal to the sum of—
...
- **(e)**
  ...
  - **(2)**
    - **(A)** No penalty shall be imposed by paragraph (1)(B) on any failure to properly calculate the excess benefit during any period for which it is established to the satisfaction of the Secretary that the employer or plan sponsor neither knew, nor exercising reasonable diligence would have known, that such failure existed.
    - **(B)** No penalty shall be imposed by paragraph (1)(B) on any such failure if—
    ...
    - **(C)** In the case of any such failure which is due to reasonable cause and not to willful neglect, the Secretary may waive part or all of the penalty imposed by paragraph (1), to the extent that the payment of such penalty would be excessive or otherwise inequitable relative to the failure involved.
- **(f)** For purposes of this section—
  - **(1)**
    - **(A)** Except as provided in subparagraph (B), an employee shall be treated as having self-only coverage with respect to any applicable employer-sponsored coverage of an employer.
    - **(B)** An employee shall be treated as having coverage other than self-only coverage only if the employee is enrolled in coverage other than self-only coverage in a group health plan which provides minimum essential coverage (as defined in section 5000A(f)) to the employee and at least one other beneficiary, and the benefits provided under such minimum essential coverage do not vary based on whether any individual covered under such coverage is the employee or another beneficiary.
  - **(2)** The term “qualified retiree” means any individual who—
  ...
  - **(6)** The term “person that administers the plan benefits” shall include the plan sponsor if the plan sponsor administers benefits under the plan.
