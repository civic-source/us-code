---
title: "Section 4980D - Failure to meet certain group health plan requirements"
usc_title: 26
usc_section: "4980D"
chapter: 43
current_through: "PL 113-108"
classification: "26 U.S.C. § 4980D"
generated_at: "2026-03-30T03:49:33.645Z"
status: "active"
---
...
- **(b)**
  - **(1)** The amount of the tax imposed by subsection (a) on any failure shall be $100 for each day in the noncompliance period with respect to each individual to whom such failure relates.
...
- **(c)**
  - **(1)** No tax shall be imposed by subsection (a) on any failure during any period for which it is established to the satisfaction of the Secretary that the person otherwise liable for such tax did not know, and exercising reasonable diligence would not have known, that such failure existed.
  ...
  - **(3)** In the case of failures which are due to reasonable cause and not to willful neglect—
    - **(A)**
      - **(i)** In the case of failures with respect to plans other than specified multiple employer health plans, the tax imposed by subsection (a) for failures during the taxable year of the employer shall not exceed the amount equal to the lesser of—
    ...
    - **(B)**
      - **(i)** In the case of failures with respect to a specified multiple employer health plan, the tax imposed by subsection (a) for failures during the taxable year of the trust forming part of such plan shall not exceed the amount equal to the lesser of—
