---
title: "Section 4980C - Requirements for issuers of qualified long-term care insurance contracts"
usc_title: 26
usc_section: "4980C"
chapter: 43
...
- **(b)**
  - **(1)** The amount of the tax imposed by subsection (a) shall be $100 per insured for each day any requirement of subsection (c) or (d) is not met with respect to each qualified long-term care insurance contract.
...
- **(c)** The requirements of this subsection are as follows:
  - **(1)**
    - **(A)** The following requirements of the model regulation must be met:
