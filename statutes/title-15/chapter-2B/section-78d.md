---
title: "Section 78d - Securities and Exchange Commission"
usc_title: 15
usc_section: "78d"
chapter: 2
current_through: "PL 113-185"
classification: "15 U.S.C. § 78d"
generated_at: "2026-03-30T04:08:11.035Z"
status: "active"
---
...
- **(g)**
  ...
  - **(2)**
    ...
    - **(B)** The annual rate of pay for the Investor Advocate shall be equal to the highest rate of annual pay for other senior executives who report to the Chairman of the Commission.
    - **(C)** An individual who serves as the Investor Advocate may not be employed by the Commission—
  ...
  - **(3)** The Investor Advocate, after consultation with the Chairman of the Commission, may retain or employ independent counsel, research staff, and service staff, as the Investor Advocate deems necessary to carry out the functions, powers, and duties of the Office.
  - **(4)** The Investor Advocate shall—
  ...
  - **(5)** The Commission shall ensure that the Investor Advocate has full access to the documents of the Commission and any self-regulatory organization, as necessary to carry out the functions of the Office.
  - **(6)**
    - **(A)**
      ...
      - **(ii)** Each report required under clause (i) shall contain full and substantive analysis and explanation.
    - **(B)**
      ...
      - **(ii)** Each report required under clause (i) shall include—
      ...
      - **(iii)** Each report required under this paragraph shall be provided directly to the Committees listed in clause (i) without any prior review or comment from the Commission, any commissioner, any other officer or employee of the Commission, or the Office of Management and Budget.
      - **(iv)** No report required under clause (i) may contain confidential information.
  - **(7)** The Commission shall, by regulation, establish procedures requiring a formal response to all recommendations submitted to the Commission by the Investor Advocate, not later than 3 months after the date of such submission.
  - **(8)**
    - **(A)** Not later than 180 days after the date on which the first Investor Advocate is appointed under paragraph (2)(A)(i), 2 2 So in original. Probably should be “(2)(A)(ii),”. the Investor Advocate shall appoint an Ombudsman, who shall report directly to the Investor Advocate.
    - **(B)** The Ombudsman appointed under subparagraph (A) shall—
    ...
    - **(C)** In carrying out the duties of the Ombudsman under subparagraph (B), the Ombudsman shall utilize personnel of the Commission to the extent practicable. Nothing in this paragraph shall be construed as replacing, altering, or diminishing the activities of any ombudsman or similar office of any other agency.
    - **(D)** The Ombudsman shall submit a semiannual report to the Investor Advocate that describes the activities and evaluates the effectiveness of the Ombudsman during the preceding year. The Investor Advocate shall include the reports required under this section in the reports required to be submitted by the Inspector Advocate under paragraph (6).
- **(h)**
  - **(1)** The Division of Trading and Markets of the Commission, or any successor organizational unit, shall have a staff of examiners who shall—
  ...
  - **(2)** The Division of Investment Management of the Commission, or any successor organizational unit, shall have a staff of examiners who shall—
    - **(A)** perform compliance inspections and examinations of entities under the jurisdiction of that Division; and
    - **(B)** report to the Director of that Division.
- **(i)**
