---
title: "Section 8512a - Learning excellence and good examples from new developers"
usc_title: 15
usc_section: "8512a"
chapter: 111
...
- **(a)** In this section:
  ...
  - **(3)** The term “Earth Prediction Innovation Center” means the community global weather research modeling system described in paragraph (5)(E) of section 8512(b) of this title .
  - **(4)** The term “model” means any vetted numerical model and associated data assimilation of the Earth’s system or its components—
  ...
  - **(5)** The term “open license” has the same meaning given such term in section 3502(21) of title 44 .
  - **(6)** The term “operational model” means any model that has an output used by the Administration for operational functions.
  - **(7)** The term “suitable model” means a model that meets the requirements described in paragraph (5)(E)(ii) of section 8512(b) of this title , as determined by the Administrator.
...
- **(c)**
  - **(1)** The Administrator shall develop and implement a plan to make available to the public, at no cost and with no restrictions on copying, publishing, distributing, citing, adapting, or otherwise using under an open license, the following:
...
- **(e)**
  - **(1)** Not later than 2 years after December 23, 2022 , the Administrator shall submit to the appropriate congressional committees a report on the implementation of this section that includes a description of—
...
- **(f)**
  - **(1)** Notwithstanding any other provision of this section, for models developed in whole or in part with the Department of Defense, the Administrator, in consultation with the Secretary of Defense, as appropriate, shall withhold any model or data if the Administrator or the Secretary of Defense determines doing so to be necessary to protect the national security interests of the United States.
...
- **(g)** There is authorized to be appropriated to carry out this section $2,000,000 for each of fiscal years 2023 through 2027.
