---
title: "Section 2073 - Additional enforcement of product safety rules and section 2064 orders"
usc_title: 15
usc_section: "2073"
chapter: 47
current_through: "PL 119-73"
classification: "15 U.S.C. § 2073"
generated_at: "2026-03-29T02:11:34.263Z"
---
...
- **(b)**
  ...
  - **(2)**
    - **(A)** A State shall provide written notice to the Commission regarding any civil action under paragraph (1). Except when proceeding under subparagraph (C), the State shall provide the notice at least 30 days before the date on which the State intends to initiate the civil action by filing a complaint.
    - **(B)** A State may initiate the civil action by filing a complaint—
    ...
    - **(D)** The written notice required by this paragraph may be provided by electronic mail, facsimile machine, or any other means of communication accepted by the Commission.
    - **(E)** A State shall provide a copy of the complaint to the Commission upon filing the complaint or as soon as possible thereafter.
  - **(3)** The Commission may intervene in such civil action and upon intervening—
    - **(A)** be heard on all matters arising in such civil action; and
    - **(B)** file petitions for appeal of a decision in such civil action.
  - **(4)** Nothing in this section, section 1264(d) of this title , section 1477 of this title , or section 1194(a) of this title shall be construed—
  ...
  - **(5)** No separate suit shall be brought under this subsection (other than a suit alleging a violation of paragraph (1) or (2) of section 2068(a) of this title ) if, at the time the suit is brought, the same alleged violation is the subject of a pending civil or criminal action by the United States under this chapter.
  - **(6)** If private counsel is retained to assist in any civil action under paragraph (1), the private counsel retained to assist the State may not—
