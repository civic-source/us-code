---
title: "Section 9009c - Support for restaurants"
usc_title: 15
usc_section: "9009c"
chapter: 116
current_through: "PL 118-78"
classification: "15 U.S.C. § 9009c"
generated_at: "2026-03-30T01:34:59.084Z"
---
...
- **(a)** In this section:
  ...
  - **(5)** The terms “exchange”, “issuer”, and “security” have the meanings given those terms in section 78c(a) of this title .
  - **(6)** The term “Fund” means the Restaurant Revitalization Fund established under subsection (b).
  - **(7)** The term “pandemic-related revenue loss” means, with respect to an eligible entity—
    ...
    - **(D)** if the eligible entity has not yet opened as of the date of application for a grant under subsection (c), but has incurred expenses described in subsection (c)(5)(A) as of March 11, 2021 —
      ...
      - **(ii)** an amount based on a formula determined by the Administrator.
  - **(8)** The term “payroll costs” has the meaning given the term in section 636(a)(36)(A) of this title , except that such term shall not include—
  ...
  - **(9)** The term “publicly-traded company” means an entity that is majority owned or controlled by an entity that is an issuer, the securities of which are listed on a national securities exchange under section 78f of this title .
  - **(10)** The term “Tribally-owned concern” has the meaning given the term in section 124.3 of title 13, Code of Federal Regulations, or any successor regulation.
- **(b)**
  - **(1)** There is established in the Treasury of the United States a fund to be known as the Restaurant Revitalization Fund.
  - **(2)**
    - **(A)** In addition to amounts otherwise available, there is appropriated to the Restaurant Revitalization Fund for fiscal year 2021, out of any money in the Treasury not otherwise appropriated, $28,600,000,000, to remain available until expended.
    - **(B)**
      ...
      - **(ii)** The Administrator may make adjustments as necessary to the distribution of funds under clause (i)(II) based on demand and the relative local costs in the markets in which eligible entities operate.
    - **(C)** Notwithstanding subparagraph (B), on and after the date that is 60 days after March 11, 2021 , or another period of time determined by the Administrator, the Administrator may make grants using amounts appropriated under subparagraph (A) to any eligible entity regardless of the annual gross receipts of the eligible entity.
  - **(3)** The Administrator shall use amounts in the Fund to make grants described in subsection (c).
- **(c)**
  - **(1)** Except as provided in subsection (b) and paragraph (3), the Administrator shall award grants to eligible entities in the order in which applications are received by the Administrator.
  - **(2)**
    - **(A)** An eligible entity applying for a grant under this subsection shall make a good faith certification that—
  ...
  - **(3)**
    ...
    - **(B)** For purposes of establishing priority under subparagraph (A), an applicant shall submit a self-certification of eligibility for priority with the grant application.
  - **(4)**
    - **(A)** The aggregate amount of grants made to an eligible entity and any affiliated businesses of the eligible entity under this subsection—
      - **(i)** shall not exceed $10,000,000; and
      - **(ii)** shall be limited to $5,000,000 per physical location of the eligible entity.
    - **(B)**
      - **(i)** Except as provided in this paragraph, the amount of a grant made to an eligible entity under this subsection shall be equal to the pandemic-related revenue loss of the eligible entity.
      - **(ii)** Any amount of a grant made under this subsection to an eligible entity based on estimated receipts that is greater than the actual gross receipts of the eligible entity in 2020 shall be returned to the Treasury.
  - **(5)** During the covered period, an eligible entity that receives a grant under this subsection may use the grant funds for the following expenses incurred as a direct result of, or during, the COVID–19 pandemic:
    - **(A)** Payroll costs.
