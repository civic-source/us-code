...
- **(c)**
  - **(1)** The Administrator shall pay the principal, interest, and any associated fees that are owed on a covered loan in a regular servicing status—
...
- **(f)** There is authorized to be appropriated to the Administrator $17,000,000,000 to carry out this section.
