---
title: "Section 2221 - Arson prevention grants"
usc_title: 15
usc_section: "2221"
chapter: 49
current_through: "PL 116-65"
classification: "15 U.S.C. § 2221"
generated_at: "2026-03-30T08:44:52.688Z"
status: "active"
---
...
- **(a)** As used in this section:
  - **(1)** The term “arson” includes all incendiary and suspicious fires.
  - **(2)** The term “Office” means the Office of Fire Prevention and Arson Control of the United States Fire Administration.
- **(b)** The Administrator, acting through the Office, shall carry out a demonstration program under which not more than 10 grant awards shall be made to States, or consortia of States, for programs relating to arson research, prevention, and control.
- **(c)** In carrying out this section, the Administrator shall award 2-year grants on a competitive, merit basis to States, or consortia of States, for projects that promote one or more of the following goals:
...
- **(f)** A grant awarded under this section may be extended for one or more additional periods, at the discretion of the Administrator, subject to the availability of appropriations.
- **(g)** The Administrator shall provide technical assistance to States in carrying out programs funded by grants under this section.
- **(h)** In carrying out this section, the Administrator shall consult and cooperate with other Federal agencies to enhance program effectiveness and avoid duplication of effort, including the conduct of regular meetings initiated by the Administrator with representatives of other Federal agencies concerned with arson and concerned with efforts to develop a more comprehensive profile of the magnitude of the national arson problem.
- **(i)** Not later than 18 months after May 19, 1994 , the Administrator shall submit a report to Congress that—
...
- **(j)** Not later than 90 days after May 19, 1994 , the Administrator shall issue regulations to implement this section, including procedures for grant applications.
- **(k)** The Administrator shall directly administer the grant program required by this section, and shall not enter into any contract under which the grant program or any portion of the program will be administered by another party.
- **(l)**
  - **(1)** It is the sense of Congress that any recipient of a grant under this section should purchase, when available and cost-effective, American made equipment and products when expending grant monies.
  - **(2)** In allocating grants under this section, the Administrator shall provide to each recipient a notice describing the statement made in paragraph (1) by the Congress.
