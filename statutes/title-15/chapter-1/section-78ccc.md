---
title: "Section 78ccc - Securities Investor Protection Corporation"
usc_title: 15
usc_section: "78ccc"
chapter: 1
current_through: "PL 114-254"
classification: "15 U.S.C. § 78ccc"
generated_at: "2026-03-29T18:24:08.288Z"
---

# § 78ccc. Securities Investor Protection Corporation

- **(a)**
  - **(1)** There is hereby established a body corporate to be known as the “Securities Investor Protection Corporation” (hereafter in this chapter referred to as “SIPC”). SIPC shall be a nonprofit corporation and shall have succession until dissolved by Act of the Congress. SIPC shall—
  ...
  - **(2)**
    - **(A)** SIPC shall be a membership corporation the members of which shall be all persons registered as brokers or dealers under section 78 o (b) of this title, other than—
...
- **(c)**
  - **(1)** SIPC shall have a Board of Directors which, subject to the provisions of this chapter, shall determine the policies which shall govern the operations of SIPC.
  - **(2)** The Board of Directors shall consist of seven persons as follows:
  ...
  - **(3)** The President shall designate a Chairman and Vice Chairman from among those directors appointed under paragraph (2)(C)(ii) of this subsection.
  - **(4)**
...
- **(e)**
  ...
  - **(2)**
    ...
    - **(E)** Notwithstanding any other provision of this paragraph, a proposed rule change may take effect—
  ...
  - **(3)** The Commission may, by such rules as it determines to be necessary or appropriate in the public interest or to carry out the purposes of this chapter, require SIPC to adopt, amend, or repeal any SIPC bylaw or rule, whenever adopted.
