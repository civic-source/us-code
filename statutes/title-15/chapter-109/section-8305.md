...
- **(b)** In this section:
  ...
  - **(2)**
    ...
    - **(B)** The term “swaps entity” does not include any major swap participant or major security-based swap participant that is an 1 1 So in original. Probably should be “a”. covered depository institution.
  - **(3)**
...
- **(d)**
  - **(1)** The prohibition in subsection (a) shall not apply to any covered depository institution that limits its swap and security-based swap activities to the following:
    ...
    - **(B)** Acting as a swaps entity for swaps or security-based swaps other than a structured finance swap.
    - **(C)** Acting as a swaps entity for swaps or security-based swaps that are structured finance swaps, if—
...
- **(i)**
  ...
  - **(3)** Taxpayers shall bear no losses from the exercise of any authority under this title. 2 2 See References in Text note below.
