---
title: "Section 7704 - Other protections for users of commercial electronic mail"
usc_title: 15
usc_section: "7704"
chapter: 103
current_through: "PL 113-126"
classification: "15 U.S.C. § 7704"
generated_at: "2026-03-30T03:59:45.970Z"
status: "active"
---
...
- **(a)**
  ...
  - **(3)**
    - **(A)** It is unlawful for any person to initiate the transmission to a protected computer of a commercial electronic mail message that does not contain a functioning return electronic mail address or other Internet-based mechanism, clearly and conspicuously displayed, that—
  ...
  - **(4)**
    ...
    - **(B)** A prohibition in subparagraph (A) does not apply if there is affirmative consent by the recipient subsequent to the request under subparagraph (A).
  - **(5)**
...
- **(b)**
  - **(1)**
    ...
    - **(B)** Nothing in this paragraph creates an ownership or proprietary interest in such electronic mail addresses.
  - **(2)** It is unlawful for any person to use scripts or other automated means to register for multiple electronic mail accounts or online user accounts from which to transmit to a protected computer, or enable another person to transmit to a protected computer, a commercial electronic mail message that is unlawful under subsection (a).
  - **(3)** It is unlawful for any person knowingly to relay or retransmit a commercial electronic mail message that is unlawful under subsection (a) from a protected computer or computer network that such person has accessed without authorization.
- **(c)** The Commission shall by regulation, pursuant to section 7711 of this title —
...
- **(d)**
  - **(1)** No person may initiate in or affecting interstate commerce the transmission, to a protected computer, of any commercial electronic mail message that includes sexually oriented material and—
  ...
  - **(2)** Paragraph (1) does not apply to the transmission of an electronic mail message if the recipient has given prior affirmative consent to receipt of the message.
