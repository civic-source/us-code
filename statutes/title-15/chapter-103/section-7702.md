---
title: "Section 7702 - Definitions"
usc_title: 15
usc_section: "7702"
chapter: 103
...
In this chapter:
  ...
  - **(2)**
    - **(A)** The term “commercial electronic mail message” means any electronic mail message the primary purpose of which is the commercial advertisement or promotion of a commercial product or service (including content on an Internet website operated for a commercial purpose).
  ...
  - **(16)**
    - **(A)** Except as provided in subparagraph (B), the term “sender”, when used with respect to a commercial electronic mail message, means a person who initiates such a message and whose product, service, or Internet web site is advertised or promoted by the message.
  ...
  - **(17)**
    - **(A)** The term “transactional or relationship message” means an electronic mail message the primary purpose of which is—
