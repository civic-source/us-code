---
title: "Section 3228 - Worker ownership, readiness, and knowledge"
usc_title: 29
usc_section: "3228"
chapter: 32
...
- **(b)**
  - **(1)** The Secretary shall establish within the Department of Labor an Employee Ownership Initiative to promote employee ownership.
...
- **(c)**
  - **(1)** Not later than 180 days after December 29, 2022 , the Secretary shall establish a program to encourage new programs and existing programs within the States to foster employee ownership throughout the United States.
...
- **(d)**
  - **(1)** In carrying out the program established under subsection (c), the Secretary may make grants for use in connection with new programs and existing programs within a State for any of the following activities:
  ...
  - **(5)**
    - **(A)** If a State fails to support or establish a program pursuant to this section during any fiscal year, the Secretary shall, in the subsequent fiscal years, allow local entities described in paragraph (4) from that State to make applications for grants under paragraph (3) on their own initiative.
...
- **(g)**
  - **(1)** There are authorized to be appropriated for the purpose of making grants pursuant to subsection (d) the following:
