---
title: "Section 1341 - Termination of single-employer plans"
usc_title: 29
usc_section: "1341"
chapter: 18
...
(b) 
  ...
  (2) 
    ...
    (B) No later than the date on which a notice is sent by the plan administrator under subparagraph (A), the plan administrator shall send a notice to each person who is a participant or beneficiary under the plan—
  ...
  (3) 
    (A) In connection with any final distribution of assets pursuant to the standard termination of the plan under this subsection, the plan administrator shall distribute the assets in accordance with section 1344 of this title . In distributing such assets, the plan administrator shall—
  ...
  (5) 
    ...
    (B) Subparagraph (A) shall not apply to any transaction or series of transactions unless—
    ...
    (C) For purposes of subparagraph (A), a plan shall be treated as fully funded with respect to any transaction or series of transactions if—
...
(c) 
  ...
  (2) 
    ...
    (B) Upon receipt of the notice of intent to terminate required under subsection (a)(2) and the information required under subparagraph (A), the corporation shall determine whether the requirements of this subparagraph are met as provided in clause (i), (ii), or (iii). The requirements of this subparagraph are met if each person who is (as of the proposed termination date) a contributing sponsor of such plan or a member of such sponsor’s controlled group meets the requirements of any of the following clauses:
      ...
      (ii) The requirements of this clause are met by a person if—
      ...
      (iii) The requirements of this clause are met by a person if such person demonstrates to the satisfaction of the corporation that—
    ...
    (C) The corporation shall notify the plan administrator as soon as practicable of its determinations made pursuant to subparagraph (B).
    (D) 
      (i) A plan administrator that has filed a notice of intent to terminate under subsection (a)(2) shall provide to an affected party any information provided to the corporation under subparagraph (A) or the regulations under subsection (a)(2) not later than 15 days after—
      ...
      (ii) 
        (I) The plan administrator shall not provide information under clause (i) in a form that includes any information that may directly or indirectly be associated with, or otherwise identify, an individual participant or beneficiary.
        (II) A court may limit disclosure under this subparagraph of confidential information described in section 552(b) of title 5 to any authorized representative of the participants or beneficiaries that agrees to ensure the confidentiality of such information.
      (iii) 
        ...
        (II) A plan administrator may charge a reasonable fee for any information provided under this subparagraph in other than electronic form.
      (iv) For purposes of this subparagraph, the term “authorized representative” means any employee organization representing participants in the pension plan.
  (3) 
    (A) If the corporation determines that the requirements for a distress termination set forth in paragraphs (1) and (2) are met, the corporation shall—
