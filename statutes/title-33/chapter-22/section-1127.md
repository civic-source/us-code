...
- **(b)**
  ...
  - **(2)**
    ...
    - **(B)** In placing fellows in offices described in subparagraph (A), the Secretary shall ensure that placements are equitably distributed among the political parties.
  - **(3)** A fellowship awarded under this subsection shall be for a period of not more than 1 year.
