...
- **(a)** The commissioned grades in the commissioned officer corps of the Administration are the following, in relative rank with officers of the Navy:
  - **(1)** Vice admiral.
  - **(2)** Rear admiral.
...
- **(c)**
  - **(1)** Not less frequently than once each year, the Secretary shall make a computation to determine the number of officers on the lineal list authorized to be serving in each grade.
