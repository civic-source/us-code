...
(c) 
  (1) 
    ...
    (C) On publication of a notice relating to an application under subparagraph (B)(ii)(I), the Secretary shall be subject to subsection (f).
  (2) Each application shall include such financial, technical, and other information as the Secretary determines to be necessary or appropriate, including—
...
(k) 
  (1) In this subsection, the term “applicable deadline”, with respect to an applicant, means the deadline or date applicable to the applicant under any of the following:
  ...
  (2) If the Secretary suspends or delays an applicable deadline, the Secretary shall submit to the applicant, and publish in the Federal Register, a written statement—
