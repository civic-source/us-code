---
title: "Section 579a - Project deauthorizations"
usc_title: 33
usc_section: "579a"
chapter: 12
...
- **(b)**
  ...
  - **(4)**
    - **(A)** The Secretary shall compile and publish a complete list of all projects and separable elements of projects of the Corps of Engineers that are authorized for construction but have not been completed.
    - **(B)** The Secretary shall include on the list developed under subparagraph (A) for each project and separable element on that list—
    ...
    - **(C)**
      - **(i)** Not later than 1 year after June 10, 2014 , the Secretary shall submit a copy of the list developed under subparagraph (A) to—
      ...
      - **(ii)** Beginning on the date the Secretary submits the report to Congress under clause (i), the Secretary shall make a copy of the list available on a publicly accessible Internet site in a manner that is downloadable, searchable, and sortable.
