---
title: "Section 1301 - Sewer overflow and stormwater reuse municipal grants"
usc_title: 33
usc_section: "1301"
chapter: 26
current_through: "PL 118-145"
classification: "33 U.S.C. § 1301"
generated_at: "2026-03-30T01:57:08.419Z"
---

# § 1301. Sewer overflow and stormwater reuse municipal grants

- **(a)**
  - **(1)** The Administrator may make grants to States for the purpose of providing grants to a municipality or municipal entity for planning, design, and construction of—
...
- **(c)**
  - **(1)** In subsection (b), the term “financially distressed community” means a community that meets affordability criteria established by the State in which the community is located, if such criteria are developed after public review and comment.
...
- **(d)**
  - **(1)** The Federal share of the cost of activities carried out using amounts from a grant made under subsection (a) shall be not less than 55 percent of the cost.
...
- **(g)**
  - **(1)** Subject to subsection (h), the Administrator shall use the amounts appropriated to carry out this section for fiscal year 2019 for making grants to municipalities and municipal entities under subsection (a)(2) in accordance with the criteria set forth in subsection (b).
