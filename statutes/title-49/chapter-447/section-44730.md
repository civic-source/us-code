---
title: "Section 44730 - Helicopter air ambulance operations"
usc_title: 49
usc_section: "44730"
chapter: 447
...
- **(c)** In conducting the rulemaking proceeding under subsection (b), the Administrator shall address the following:
...
- **(d)** In issuing a final rule under subsection (b), the Administrator, at a minimum, shall provide for the following:
...
- **(e)**
  - **(1)** Upon completion of the rulemaking required under subsection (b), the Administrator shall conduct a follow-on rulemaking to address the following:
  ...
  - **(2)** Not later than 180 days after the date of issuance of a final rule under subsection (b), the Administrator shall initiate the rulemaking under this subsection.
  - **(3)** Nothing in this subsection shall be construed to require the Administrator to propose or finalize any rule that would derogate or supersede the rule required to be finalized under subsection (b).
