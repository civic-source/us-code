---
title: "Section 6703 - National culvert removal, replacement, and restoration grant program"
usc_title: 49
usc_section: "6703"
chapter: 67
current_through: "PL 117-81"
classification: "49 U.S.C. § 6703"
generated_at: "2026-03-29T22:06:49.723Z"
---
...
- **(a)** In this section:
  ...
  - **(3)** The term “program” means the annual competitive grant program established under subsection (b).
  - **(4)** The term “Secretary” means the Secretary of Transportation.
  - **(5)** The term “Undersecretary” means the Undersecretary of Commerce for Oceans and Atmosphere.
- **(b)** The Secretary, in consultation with the Undersecretary, shall establish an annual competitive grant program to award grants to eligible entities for projects for the replacement, removal, and repair of culverts or weirs that—
  ...
  - **(2)** with respect to weirs, may include—
    ...
    - **(B)** weir improvements.
- **(c)** An entity eligible to receive a grant under the program is—
  - **(1)** a State;
...
- **(f)** The Federal share of the cost of a project carried out with a grant to a State or a unit of local government under the program shall be not more than 80 percent.
...
- **(i)** There is authorized to be appropriated to carry out the program $800,000,000 for each of fiscal years 2022 through 2026.
