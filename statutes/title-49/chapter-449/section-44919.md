---
title: "Section 44919 - PreCheck Program"
usc_title: 49
usc_section: "44919"
chapter: 449
current_through: "PL 117-28"
classification: "49 U.S.C. § 44919"
generated_at: "2026-03-29T20:47:02.938Z"
---

# § 44919. PreCheck Program

- **(a)** The Administrator of the Transportation Security Administration shall continue to administer the PreCheck Program in accordance with section 109(a)(3) of the Aviation and Transportation Security Act ( 49 U.S.C. 114 note).
...
- **(c)** At least 1 agreement under subsection (b) shall include the following capabilities:
...
- **(d)** At least 1 agreement under subsection (b) shall include the following capabilities:
  - **(1)** Start-to-finish secure online or mobile enrollment capability.
...
- **(e)** Subject to subsections (b), (c), and (d), the Administrator shall take actions to expand the total number of individuals enrolled in the PreCheck Program as follows:
...
- **(f)** Not later than 90 days after the date of enactment of the TSA Modernization Act, the Administrator shall—
...
- **(i)**
  - **(1)** Subject to paragraph (3), an individual specified in paragraph (2) is eligible for expedited security screening under the PreCheck Program.
  - **(2)** An individual specified in this subsection is any of the following:
  ...
  - **(3)** The eligibility of an individual specified in paragraph (2) for expedited security screening under the PreCheck Program is subject to such policies and procedures as the Administrator may prescribe to carry out this subsection, in consultation with the Secretary of Defense and, with respect to the United States Coast Guard, the Commandant of the United States Coast Guard.
- **(j)** The Administrator shall initiate an assessment to identify any security vulnerabilities in the vetting process for the PreCheck Program, including determining whether subjecting PreCheck Program participants to recurrent fingerprint-based criminal history records checks, in addition to recurrent checks against the terrorist watchlist, could be done in a cost-effective manner to strengthen the security of the PreCheck Program.
- **(k)** In carrying out this section, the Administrator shall ensure that the additional private sector application capabilities under subsections (b), (c), and (d) are undertaken in addition to any other related TSA program, initiative, or procurement, including the Universal Enrollment Services program.
- **(l)** Any Federal funds expended by the Administrator to expand PreCheck Program enrollment shall be expended in a manner that includes the requirements of this section.
