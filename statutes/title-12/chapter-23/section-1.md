...
- **(b)**
  - **(1)** In establishing the risk-based capital test under subsection (a) of this section—
...
- **(c)** For purposes of this part, the risk-based capital level for the Corporation shall be equal to the sum of the following amounts:
  - **(1)** The amount of regulatory capital determined by applying the risk-based capital test under subsection (a) of this section to the Corporation, adjusted to account for foreign exchange risk.
  - **(2)** To provide for management and operations risk, 30 percent of the amount of regulatory capital determined by applying the risk-based capital test under subsection (a) of this section to the Corporation.
- **(d)**
  - **(1)** The regulations establishing the risk-based capital test under this section shall—
