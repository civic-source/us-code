---
title: "Section 5007 - Expedited recredit procedures for banks"
usc_title: 12
usc_section: "5007"
chapter: 50
current_through: "PL 117-122"
classification: "12 U.S.C. § 5007"
generated_at: "2026-03-29T22:25:05.095Z"
---

# § 5007. Expedited recredit procedures for banks

- **(a)**
  - **(1)** A bank may make a claim against an indemnifying bank for expedited recredit for which that bank is indemnified if—
  ...
  - **(2)** Any claim under paragraph (1) may be submitted by the claimant bank to an indemnifying bank before the end of the 120-day period beginning on the date of the transaction that gave rise to the claim.
- **(b)**
  - **(1)** To make a claim under subsection (a) for an expedited recredit relating to a substitute check, the claimant bank shall send to the indemnifying bank—
    - **(A)** a description of—
  ...
  - **(2)** If the information submitted by a claimant bank pursuant to paragraph (1) in connection with a claim for an expedited recredit includes a copy of any substitute check for which any such claim is made, the claimant bank shall take reasonable steps to ensure that any such copy cannot be—
  ...
  - **(3)**
    - **(A)** An indemnifying bank may, in the discretion of the bank, require the claimant bank to submit the information required by paragraph (1) in writing, including a copy of the written or electronically submitted claim, if any, that the consumer provided in accordance with section 5006(b) of this title .
    - **(B)** An indemnifying bank that requires a submission of information under subparagraph (A) may permit the claimant bank to make the submission electronically, if the claimant bank has agreed to communicate with the indemnifying bank in that manner.
- **(c)**
  - **(1)** No later than 10 business days after the business day on which an indemnifying bank receives a claim under subsection (a) from a claimant bank with respect to a substitute check, the indemnifying bank shall—
