---
title: "Section 5011 - Consumer awareness"
usc_title: 12
usc_section: "5011"
chapter: 50
...
- **(c)**
  - **(1)** Before the end of the 9-month period beginning on October 28, 2003 , the Board shall publish model forms and clauses that a bank may use to describe each of the elements required by subsection (a).
  - **(2)**
    - **(A)** A bank shall be treated as being in compliance with the requirements of subsection (a) if the bank’s substitute check notice uses a model form or clause published by the Board and such model form or clause accurately describes the bank’s policies and practices.
