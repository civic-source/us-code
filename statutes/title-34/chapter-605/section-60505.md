---
title: "Section 60505 - Audit and accountability of grantees"
usc_title: 34
usc_section: "60505"
chapter: 605
...
- **(a)** In this section—
  - **(1)** the term “covered grant program” means grants awarded under section 60511, 60521, or 60531 of this title, as amended by this title; 1 1 See References in Text note below.
...
- **(f)**
  - **(1)** A nonprofit organization that holds money in offshore accounts for the purpose of avoiding the tax described in section 511(a) of title 26 , shall not be eligible to receive, directly or indirectly, any funds from a covered grant program.
...
- **(g)**
  - **(1)** Amounts made available under a covered grant program may not be used by any covered grantee to—
