---
title: "Section 2298 - Relocation allowances"
usc_title: 19
usc_section: "2298"
chapter: 12
...
- **(a)**
  - **(1)** Any adversely affected worker covered by a certification issued under subpart A of this part may file an application for a relocation allowance with the Secretary, and the Secretary may grant the relocation allowance, subject to the terms and conditions of this section.
  - **(2)** A relocation allowance may be granted if all of the following terms and conditions are met:
    ...
    - **(E)** The worker filed an application with the Secretary before—
      - **(i)** the later of—
...
- **(b)** The relocation allowance granted to a worker under subsection (a) includes—
