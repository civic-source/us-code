...
generated_at: "2026-03-29T23:33:47.276Z"
---
...
- **(d)**
  - **(1)** The administering authority shall not accept an agreement under subsection (b) or (c) unless—
  ...
  - **(3)** In order to carry out an agreement concluded under subsection (b) or (c), the administering authority is authorized to prescribe regulations governing the entry, or withdrawal from warehouse, for consumption of subject merchandise.
- **(e)** Before an investigation may be suspended under subsection (b) or (c) the administering authority shall—
...
- **(f)**
  - **(1)** If the administering authority determines to suspend an investigation upon acceptance of an agreement described in subsection (b) or (c), then—
  ...
  - **(2)**
    - **(A)** If the agreement accepted by the administering authority is an agreement described in subsection (b), then—
