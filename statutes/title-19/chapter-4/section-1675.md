...
- **(c)**
  - **(1)** Notwithstanding subsection (b) of this section and except in the case of a transition order defined in paragraph (6), 5 years after the date of publication of—
...
- **(d)**
  ...
  - **(2)** In the case of a review conducted under subsection (c) of this section, the administering authority shall revoke a countervailing duty order or an antidumping duty order or finding, or terminate a suspended investigation, unless—
