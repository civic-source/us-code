---
title: "Section 1098h - Procedure and requirements for requesting tax return information from the Internal Revenue Service"
usc_title: 20
usc_section: "1098h"
chapter: 28
...
- **(c)**
  ...
  - **(4)** In this subsection:
    ...
    - **(B)** The term “written consent” means a separate, written document that is signed and dated (which may include by electronic format) by an applicant, which—
  ...
  - **(5)** An institution of higher education shall—
