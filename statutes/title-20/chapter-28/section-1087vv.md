---
title: "Section 1087vv - Definitions"
usc_title: 20
usc_section: "1087vv"
chapter: 28
current_through: "PL 119-43"
classification: "20 U.S.C. § 1087vv"
generated_at: "2026-03-30T02:39:22.294Z"
---
...
- **(b)** The term “untaxed income and benefits” means—
...
- **(d)** The term “independent”, when used with respect to a student, means any individual who—
...
- **(f)**
  ...
  - **(4)** In this subsection, the term “qualified education benefit” means—
...
- **(g)** The term “net value” means the market value at the time of application of the assets (as defined in subsection (f)), minus the outstanding liabilities or indebtedness against the assets.
- **(h)**
...
- **(k)**
  - **(1)** Except as provided in paragraph (3), in determining family size in the case of a dependent student—
  ...
  - **(2)** Except as provided in paragraph (3), in determining family size in the case of an independent student—
  ...
  - **(3)** The Secretary shall provide procedures for determining family size in cases in which information for the taxable year used in determining the amount of need of the student for financial assistance under this subchapter has changed or does not accurately reflect the applicant’s current household size, including when a divorce settlement only allows a parent to file for the Earned Income Tax Credit available under section 32 of title 26 .
- **(l)** The term “business assets” means property that is used in the operation of a trade or business, including real estate, inventories, buildings, machinery, and other equipment, patents, franchise rights, and copyrights.
- **(m)** The term “homeless youth” has the meaning given the term “homeless children and youths” in section 11434a of title 42 .
- **(n)** The terms “unaccompanied”, “unaccompanied youth”, or “unaccompanied homeless youth” have the meaning given the term “unaccompanied youth” in section 11434a of title 42 .
