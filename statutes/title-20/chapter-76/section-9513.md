...
- **(a)** Notwithstanding section 3472 of this title , the Secretary shall delegate to the Director all functions for carrying out this subchapter (other than administrative and support functions), except that—
...
- **(b)** The Secretary may assign the Institute responsibility for administering other activities, if those activities are consistent with—
