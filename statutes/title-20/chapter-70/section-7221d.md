---
title: "Section 7221d - National activities"
usc_title: 20
usc_section: "7221d"
chapter: 70
...
- **(a)** The Secretary shall reserve for each fiscal year the greater of 5 percent or $5,000,000 of the amount appropriated to carry out this subpart, except that in no fiscal year shall the total amount so reserved exceed $8,000,000, to carry out the following activities:
...
- **(b)**
  ...
  - **(2)**
    - **(A)** From the amount made available to carry out this subsection under paragraphs (2) and (3)(B) of section 7221j(b) of this title for any fiscal year, the Secretary shall make grants, on a competitive basis, to States to pay for the Federal share of the cost of establishing or enhancing, and administering per-pupil facilities aid programs.
  ...
  - **(3)**
    - **(A)** A State that receives a grant under this subsection shall use the funds made available through the grant to establish or enhance, and administer, a per-pupil facilities aid program for charter schools in the State.
    ...
    - **(C)** Funds made available under this subsection shall be used to supplement, and not supplant, State and local public funds expended to provide per pupil 1 1 So in original. Probably should be “per-pupil”. facilities aid programs, operations financing programs, or other programs, for charter schools.
  - **(4)**
    - **(A)** No State may be required to participate in a program carried out under this subsection.
    - **(B)** To be eligible to receive a grant under this subsection, a State shall establish or enhance, and administer, a per-pupil facilities aid program for charter schools in the State, that—
  ...
  - **(6)** In making grants under this subsection, the Secretary shall give priority to States that meet the criteria described in paragraph (2), and subparagraphs (A), (B), and (C) of paragraph (3), of section 7221a(e) of this title .
- **(c)** Nothing in this section shall be construed to require charter schools to collect any data described in subsection (a) of this section.
