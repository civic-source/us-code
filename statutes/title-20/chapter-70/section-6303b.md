---
title: "Section 6303b - Direct student services"
usc_title: 20
usc_section: "6303b"
chapter: 70
...
- **(a)**
  - **(1)**
    ...
    - **(B)** A State educational agency shall consult under subparagraph (A) with local educational agencies that include—
  ...
  - **(2)** Of the funds reserved under paragraph (1)(A), the State educational agency may use not more than 1 percent to administer the program described in this section.
- **(b)**
  - **(1)** From the amount reserved under subsection (a) by a State educational agency, the State educational agency shall award grants to geographically diverse local educational agencies described in subsection (a)(1)(B)(i).
  - **(2)** In making such awards, the State educational agency shall prioritize awards to local educational agencies serving the highest percentage of schools, as compared to other local educational agencies in the State—
...
- **(c)** A local educational agency receiving an award under this section—
...
- **(d)** A local educational agency desiring to receive an award under subsection (b) shall submit an application to the State educational agency at such time and in such manner as the State educational agency shall require. At a minimum, each application shall describe how the local educational agency will—
...
- **(e)** A State educational agency that reserves an amount under subsection (a) shall—
