---
title: "Section 7441 - Improvement of educational opportunities for Indian children"
usc_title: 20
usc_section: "7441"
chapter: 70
...
- **(a)**
  - **(1)** It is the purpose of this section to support projects to develop, test, and demonstrate the effectiveness of services and programs to improve educational opportunities and achievement of Indian children.
...
- **(c)**
  - **(1)** The Secretary shall award grants to eligible entities to enable such entities to carry out activities that meet the purpose of this section, including—
  ...
  - **(2)** Professional development of teaching professionals and paraprofessionals may be a part of any program assisted under this section.
- **(d)**
  - **(1)**
  ...
  - **(3)**
    - **(A)** Any eligible entity that desires to receive a grant under this section shall submit an application to the Secretary at such time and in such manner as the Secretary may reasonably require.
    - **(B)** Each application submitted to the Secretary under subparagraph (A), other than an application for a dissemination grant under paragraph (2), shall contain—
...
- **(e)** Not more than 5 percent of the funds provided to a grantee under this subpart for any fiscal year may be used for administrative purposes.
