---
title: "Section 6775 - Ready-to-Learn Television"
usc_title: 20
usc_section: "6775"
chapter: 70
...
- **(a)**
  - **(1)** The Secretary is authorized to award grants to, or enter into contracts or cooperative agreements with, eligible entities described in paragraph (3) to enable such entities—
  ...
  - **(3)** To be eligible to receive a grant, contract, or cooperative agreements under this section, an entity shall be a public telecommunications entity that is able to demonstrate each of the following:
...
- **(c)**
  ...
  - **(2)** The Secretary shall prepare and submit to the relevant committees of Congress a biannual report that includes the following:
...
- **(e)**
  - **(1)** There are authorized to be appropriated to carry out this section such sums as may be necessary for fiscal year 2002, and for each of the 5 succeeding fiscal years.
  - **(2)** Not less than 60 percent of the amount appropriated under paragraph (1) for each fiscal year shall be used to carry out activities under subparagraphs (B) through (D) of subsection (a)(1) of this section.
