---
title: "Section 7174 - Local competitive subgrant program"
usc_title: 20
usc_section: "7174"
chapter: 70
current_through: "PL 119-73"
classification: "20 U.S.C. § 7174"
generated_at: "2026-03-29T20:04:33.082Z"
---

# § 7174. Local competitive subgrant program

- **(a)**
  - **(1)** A State that receives funds under this part for a fiscal year shall provide the amount made available under section 7172(c)(1) of this title to award subgrants to eligible entities for community learning centers in accordance with this part.
  - **(2)** A State that receives funds under this part for a fiscal year may use funds under section 7172(c)(1) of this title to support those enrichment and engaging academic activities described in section 7175(a) of this title that—
...
- **(b)**
  - **(1)** To be eligible to receive a subgrant under this part, an eligible entity shall submit an application to the State educational agency at such time, in such manner, and including such information as the State educational agency may reasonably require.
...
- **(d)**
  - **(1)** A State educational agency may require an eligible entity to match subgrant funds awarded under this part, except that such match may not exceed the amount of the subgrant and may not be derived from other Federal or State funds.
  ...
  - **(4)** Notwithstanding this subsection, a State educational agency shall not consider an eligible entity’s ability to match funds when determining which eligible entities will receive subgrants under this part.
- **(e)** In reviewing local applications under this part, a State educational agency shall use a rigorous peer-review process or other methods to ensure the quality of funded projects.
