---
title: "Section 7174 - Local competitive grant program"
usc_title: 20
usc_section: "7174"
chapter: 70
...
- **(a)** A State that receives funds under this part for a fiscal year shall provide the amount made available under section 7172(c)(1) of this title to eligible entities for community learning centers in accordance with this part.
- **(b)**
  - **(1)** To be eligible to receive an award under this part, an eligible entity shall submit an application to the State educational agency at such time, in such manner, and including such information as the State educational agency may reasonably require.
...
- **(d)**
  - **(1)** A State educational agency may require an eligible entity to match funds awarded under this part, except that such match may not exceed the amount of the grant award and may not be derived from other Federal or State funds.
  - **(2)** The amount of a match under paragraph (1) shall be established based on a sliding fee scale that takes into account—
  ...
  - **(3)** Each State educational agency that requires an eligible entity to match funds under this subsection shall permit the eligible entity to provide all or any portion of such match in the form of in-kind contributions.
  - **(4)** Notwithstanding this subsection, a State educational agency shall not consider an eligible entity’s ability to match funds when determining which eligible entities will receive awards under this part.
- **(e)** In reviewing local applications under this section, a State educational agency shall use a peer review process or other methods of assuring the quality of such applications.
- **(f)** To the extent practicable, a State educational agency shall distribute funds under this part equitably among geographic areas within the State, including urban and rural communities.
- **(g)** Grants under this part may be awarded for a period of not less than 3 years and not more than 5 years.
- **(h)** A grant awarded under this part may not be made in an amount that is less than $50,000.
- **(i)**
  - **(1)** In awarding grants under this part, a State educational agency shall give priority to applications—
