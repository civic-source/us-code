...
- **(e)**
  ...
  - **(3)** The eligible agency shall establish an appeals procedure for resolution of any dispute arising between a local educational agency and an area career and technical education school or an educational service agency with respect to the allocation procedures described in this section, including the decision of a local educational agency to leave a consortium or terminate a cooperative arrangement.
- **(f)**
  - **(1)** Any local educational agency receiving an allocation that is not sufficient to conduct a program which meets the requirements of section 2355 of this title is encouraged to—
