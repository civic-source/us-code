...
(b) From the funds appropriated under this chapter for each fiscal year that are not reserved under subsection (a), the Secretary shall allot to each State the sum of—
...
(c) No State shall receive an allotment under subsection (b) for a fiscal year in an amount that is less than .40 percent of the total amount appropriated for the fiscal year under this chapter.
