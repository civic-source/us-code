...
- **(f)**
  - **(1)**
    ...
    - **(C)**
      ...
      - **(iv)** Each of the last nine plans developed under subparagraph (A) shall be completed not later than 30 days before each of the fiscal years 2015 through 2023, respectively.
...
- **(g)**
  - **(1)** Not later than September 30, 2009 , and annually thereafter through September 30, 2024 , the Global AIDS Coordinator shall complete a study of treatment providers that—
  ...
  - **(2)** The studies required to be submitted by September 30, 2014 , and annually thereafter through September 30, 2024 , shall include, in addition to the elements set forth under paragraph (1), the following elements:
