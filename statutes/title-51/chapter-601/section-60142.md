---
title: "Section 60142 - Archiving of data"
usc_title: 51
usc_section: "60142"
chapter: 601
...
- **(a)** It is in the public interest for the United States Government to—
...
- **(b)** The Secretary of the Interior, in consultation with the Landsat Program Management, shall provide for long-term storage, maintenance, and upgrading of a basic, global, land remote sensing data set (hereafter in this section referred to as the “basic data set”) and shall follow reasonable archival practices to ensure proper storage and preservation of the basic data set and timely access for parties requesting data.
- **(c)** In determining the initial content of, or in upgrading, the basic data set, the Secretary of the Interior shall—
