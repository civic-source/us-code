...
generated_at: "2026-03-30T09:31:02.492Z"
status: "active"
---
...
- **(k)**
  ...
  - **(3)**
    ...
    - **(B)** If subparagraph (A) applies to a nonattainment or maintenance area in a State, the percentage of the PM2.5 set-aside under paragraph (1) shall be reduced for that State proportionately based on the weighted population of the area in fine particulate matter nonattainment.
