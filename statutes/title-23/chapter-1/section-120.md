...
- **(c)**
  ...
  - **(3)**
    ...
    - **(C)**
      - **(i)** In each fiscal year, a State may use the authority under subparagraph (A) for up to 10 percent of the combined apportionments of the State under paragraphs (1), (2), (5)(D), and (6) of section 104(b).
      - **(ii)** The Federal share payable on account of a project, program, or activity described in subparagraph (A) may be increased by up to 5 percent of the total project cost.
  - **(4)** Notwithstanding any other provision of law, the Secretary may waive the non-Federal share of the cost of a project or activity under section 502(b)(6) that is carried out with amounts apportioned under section 104(b)(2) after considering appropriate factors, including whether—
...
- **(h)** Notwithstanding any other provision of this title and subject to such criteria as the Secretary may establish, a State may contribute an amount in excess of the non-Federal share of a project under this title so as to decrease the Federal share payable on such project.
- **(i)**
  - **(1)**
    ...
    - **(C)** In this paragraph, the term “Federal funds” does not include loans of Federal funds or other financial assistance that must be repaid to the Government.
  - **(2)**
    - **(A)** The credit for any non-Federal share provided under this subsection shall not reduce nor replace State funds required to match Federal funds for any program under this title.
    ...
    - **(C)** In subparagraph (B), the term “non-Federal transportation capital expenditures” includes any payments made by the State for issuance of transportation-related bonds.
  - **(3)**
    - **(A)** Use of a credit for a non-Federal share under this subsection that is received from a public, quasi-public, or private agency—
    ...
    - **(B)** When a credit that is received from a chartered multistate agency is applied to a non-Federal share under this subsection, such credit shall be applied equally to all charter States.
- **(j)** Notwithstanding any other provision of law, any Federal funds other than those made available under this title and title 49 may be used to pay the non-Federal share of the cost of any transportation project that is within, adjacent to, or provides access to Federal land, the Federal share of which is funded under this title or chapter 53 of title 49.
- **(k)** Notwithstanding any other provision of law, the funds authorized to be appropriated to carry out the tribal transportation program under section 202 and the Federal lands transportation program under section 203 may be used to pay the non-Federal share of the cost of any project that is funded under this title or chapter 53 of title 49 and that provides access to or within Federal or tribal land.
- **(l)**
  ...
  - **(2)**
    - **(A)** Notwithstanding any other provision of law, a State participating in the pilot program (referred to in this subsection as a “participating State”) may determine the Federal share on a project, multiple-project, or program basis for projects under any of the following:
    ...
    - **(B)**
      - **(i)** Subject to clause (iii), the Federal share of the cost of an individual project carried out under a program described in subparagraph (A) by a participating State and to which the participating State is applying the Federal share requirements under the pilot program may be up to 100 percent.
      - **(ii)** No individual project carried out under a program described in subparagraph (A) by a participating State and to which the participating State is applying the Federal share requirements under the pilot program shall have a Federal share of 0 percent.
      - **(iii)** The average annual Federal share of the total cost of all projects authorized under a program described in subparagraph (A) to which a participating State is applying the Federal share requirements under the pilot program shall be not more than the average of the maximum Federal share of those projects if those projects were not carried out under the pilot program.
    - **(C)**
      - **(i)** A State seeking to be a participating State shall—
      ...
      - **(ii)** For each of fiscal years 2022 through 2026, the Secretary shall select not more than 10 States to be participating States.
