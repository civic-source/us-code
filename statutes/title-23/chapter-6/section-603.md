---
title: "Section 603 - Secured loans"
usc_title: 23
usc_section: "603"
chapter: 6
...
- **(a)**
  - **(1)** Subject to paragraphs (2) and (3), the Secretary may enter into agreements with 1 or more obligors to make secured loans, the proceeds of which shall be used—
...
- **(d)**
  ...
  - **(2)** In making a sale or reoffering under paragraph (1), the Secretary may not change the original terms and conditions of the secured loan without the written consent of the obligor.
- **(e)**
