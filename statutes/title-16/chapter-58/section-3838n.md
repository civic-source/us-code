---
title: "Section 3838n - Grassland reserve program"
usc_title: 16
usc_section: "3838n"
chapter: 58
current_through: "PL 113-100"
classification: "16 U.S.C. § 3838n"
generated_at: "2026-03-29T17:51:56.974Z"
---

# § 3838n. Grassland reserve program

- **(a)** The Secretary shall establish a grassland reserve program (referred to in this subpart as the “program”) for the purpose of assisting owners and operators in protecting grazing uses and related conservation values by restoring and conserving eligible land through rental contracts, easements, and restoration agreements.
- **(b)**
  - **(1)** The Secretary shall enroll an additional 1,220,000 acres of eligible land in the program during fiscal years 2009 through 2012.
  - **(2)** The Secretary shall enroll eligible land in the program through the use of; 1 1 So in original. The semicolon probably should be a dash.
  ...
  - **(3)** Of the total amount of funds expended under the program to acquire rental contracts and easements described in paragraph (2), the Secretary shall use, to the extent practicable—
    - **(A)** 40 percent for rental contacts; and
    - **(B)** 60 percent for easements.
  - **(4)**
    - **(A)** Upon expiration of a contract under subpart B of part I of this subchapter, the Secretary shall give priority for enrollment in the program to land previously enrolled in the conservation reserve program if—
    ...
    - **(B)** The number of acres of land enrolled under the priority described in subparagraph (A) in a calendar year shall not exceed 10 percent of the total number of acres enrolled in the program in that calendar year.
- **(c)** For purposes of the program, the term “eligible land” means private or tribal land that—
