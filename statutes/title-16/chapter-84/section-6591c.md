---
title: "Section 6591c - Stewardship end result contracting projects"
usc_title: 16
usc_section: "6591c"
chapter: 84
...
- **(a)** In this section:
  - **(1)** The term “Chief” means the Chief of the Forest Service.
  - **(2)** The term “Director” means the Director of the Bureau of Land Management.
...
- **(d)**
  ...
  - **(3)**
    - **(A)** Except as provided in subparagraph (B), the Chief and the Director may enter into a contract under subsection (b) in accordance with section 3903 of title 41 .
    - **(B)** The period of the contract under subsection (b) may exceed 5 years but may not exceed 10 years.
  - **(4)**
    - **(A)** The Chief and the Director may apply the value of timber or other forest products removed as an offset against the cost of services received under the agreement or contract described in subsection (b).
    - **(B)** The value of timber or other forest products used as an offset under subparagraph (A)—
...
- **(e)**
  ...
  - **(3)**
    ...
    - **(B)** The Act of June 9, 1930 (commonly known as the “Knutson-Vanderberg 1 Act”) ( 16 U.S.C. 576 et seq.) shall not apply to any agreement or contract under subsection (b).
...
- **(h)**
  - **(1)** The Chief and the Director shall establish a multiparty monitoring and evaluation process that accesses the stewardship contracting projects conducted under this section.
  - **(2)** Other than the Chief and Director, participants in the process described in paragraph (1) may include—
    - **(A)** any cooperating governmental agencies, including tribal governments; and
    - **(B)** any other interested groups or individuals.
- **(i)** Not later than 1 year after February 7, 2014 , and annually thereafter, the Chief and the Director shall report to the Committee on Agriculture, Nutrition, and Forestry of the Senate and the Committee on Agriculture of the House of Representatives on—
