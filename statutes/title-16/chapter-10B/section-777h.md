---
title: "Section 777h - Requirements and restrictions concerning use of amounts for expenses for administration"
usc_title: 16
usc_section: "777h"
chapter: 10
...
- **(a)** Except as provided in subsection (b) of this section, the Secretary of the Interior may use available amounts under section 777c(b) of this title only for expenses for administration that directly support the implementation of this chapter that consist of—
...
- **(b)**
  - **(1)** Subject to paragraph (2), if the Secretary of the Interior determines that available amounts under section 777c(b) of this title should be used for an expense for administration other than an expense for administration described in subsection (a) of this section, the Secretary—
