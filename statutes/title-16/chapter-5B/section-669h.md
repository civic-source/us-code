...
generated_at: "2026-03-29T20:04:20.183Z"
---

# § 669h. Requirements and restrictions concerning use of amounts for expenses for administration

- **(a)** Except as provided in subsection (b), the Secretary of the Interior may use available amounts under section 669c(a)(1) of this title only for expenses for administration that directly support the implementation of this chapter that consist of—
...
- **(b)**
  - **(1)** Subject to paragraph (2), if the Secretary of the Interior determines that available amounts under section 669c(a)(1) of this title should be used for an expense for administration other than an expense for administration described in subsection (a), the Secretary—
...
- **(c)** The Secretary of the Interior shall not use available amounts under subsection (b) to supplement the funding of any function for which general appropriations are made for the United States Fish and Wildlife Service or any other entity of the Department of the Interior.
- **(d)**
