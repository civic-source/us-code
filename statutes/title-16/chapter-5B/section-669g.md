...
- **(b)**
  - **(1)** Except as provided in paragraph (2), each State may use the funds apportioned to it under section 669c(c) 1 1 Probably means section 669c(c) relating to apportionment of certain taxes. of this title to pay up to 75 per centum of the costs of a hunter safety program and the operation and maintenance of public target ranges, as a part of such program.
