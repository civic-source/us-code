---
title: "Section 344 - Telecommunications interagency working group"
usc_title: 47
usc_section: "344"
chapter: 5
current_through: "PL 117-116"
classification: "47 U.S.C. § 344"
generated_at: "2026-03-29T22:22:58.576Z"
---

# § 344. Telecommunications interagency working group

- **(a)** In this section, the term “telecommunications interagency working group” means the interagency working group established under subsection (b)(1).
- **(b)**
  ...
  - **(2)** The telecommunications interagency working group shall be considered established on the date on which a majority of the members of the working group have been appointed, consistent with subsection (d).
- **(c)** In developing recommendations under subsection (b), the telecommunications interagency working group shall—
...
- **(d)** The telecommunications interagency working group shall be composed of the following representatives of Federal agencies and relevant non-Federal industry and labor stakeholder organizations:
...
- **(e)** A member of the telecommunications interagency working group shall serve without compensation.
- **(f)**
  - **(1)** The telecommunications interagency working group shall name a chair and a vice chair, who shall be responsible for organizing the business of the working group.
  - **(2)** The chair and vice chair of the telecommunications interagency working group, in consultation with the other members of the telecommunications interagency working group, may establish such subgroups as necessary to help conduct the work of the telecommunications interagency working group.
  - **(3)** The Commission and the Secretary of Labor may detail employees of the Commission and the Department of Labor, respectively, to assist and support the work of the telecommunications interagency working group, though such a detailee shall not be considered to be a member of the working group.
- **(g)**
  - **(1)** Not later than 1 year after the date on which the telecommunications interagency working group is established, the working group shall submit a report containing its recommendations to address the workforce needs of the telecommunications industry to—
    ...
    - **(F)** the Commission.
  - **(2)** The telecommunications interagency working group may not submit the report under paragraph (1) unless the report has the support of not less than the majority of the members of the working group.
  - **(3)** The telecommunications interagency working group shall—
  ...
  - **(4)** The Commission and the Secretary of Labor shall make a copy of the report submitted under paragraph (1) available to the public on the websites of the Commission and the Department of Labor, respectively.
- **(h)** The Federal Advisory Committee Act (5 U.S.C. App.) shall not apply to the telecommunications interagency working group.
