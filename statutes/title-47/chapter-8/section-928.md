---
title: "Section 928 - Spectrum Relocation Fund"
usc_title: 47
usc_section: "928"
chapter: 8
current_through: "PL 117-24"
classification: "47 U.S.C. § 928"
generated_at: "2026-03-29T20:35:00.383Z"
---

# § 928. Spectrum Relocation Fund

- **(a)** There is established on the books of the Treasury a separate fund to be known as the “Spectrum Relocation Fund” (in this section referred to as the “Fund”), which shall be administered by the Office of Management and Budget (in this section referred to as “OMB”), in consultation with the NTIA.
...
- **(d)**
  ...
  - **(3)**
    ...
    - **(C)**
      - **(i)** The Director of OMB may transfer under subparagraph (A) not more than $10,000,000 for costs incurred after June 28, 2010 , but before February 22, 2012 .
      - **(ii)** Any amounts transferred by the Director of OMB pursuant to clause (i) shall be in addition to any amounts that the Director of OMB may transfer for costs incurred on or after February 22, 2012 .
...
- **(f)**
  ...
  - **(2)**
    - **(A)** The Director of OMB, in consultation with the NTIA, may use amounts made available under paragraph (1) to make payments to eligible Federal entities that are implementing a transition plan submitted under section 923(h)(1) of this title in order to encourage such entities to complete the implementation more quickly, thereby encouraging timely access to the eligible frequencies that are being reallocated for exclusive non-Federal use or shared use.
    - **(B)** In the case of any payment by the Director of OMB under subparagraph (A)—
