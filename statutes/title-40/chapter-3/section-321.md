---
title: "Section 321 - Acquisition Services Fund"
usc_title: 40
usc_section: "321"
chapter: 3
current_through: "PL 118-30"
classification: "40 U.S.C. § 321"
generated_at: "2026-03-30T00:35:11.819Z"
---

# § 321. Acquisition Services Fund

- **(a)** The Acquisition Services Fund is a special fund in the Treasury.
- **(b)**
  - **(1)** The Fund is composed of amounts authorized to be transferred to the Fund or otherwise made available to the Fund.
  - **(2)** The Fund shall be credited with all reimbursements, advances, and refunds or recoveries relating to personal property or services procured through the Fund, including—
...
- **(c)**
  ...
  - **(2)** The Fund may be used for the procurement of personal property and nonpersonal services authorized to be acquired by—
...
- **(d)**
  - **(1)** For property or services procured through the Fund for requisitioning agencies, the agencies shall pay prices the Administrator fixes under this subsection.
  - **(2)** The Administrator shall fix prices at levels sufficient to recover—
  ...
  - **(3)**
    - **(A)** A requisitioning agency shall pay in advance when the Administrator determines that there is insufficient capital otherwise available in the Fund. Payment in advance may also be made under an agreement between a requisitioning agency and the Administrator.
    - **(B)** If payment is not made in advance, the Administration shall be reimbursed promptly out of amounts of the requisitioning agency in accordance with accounting procedures approved by the Comptroller General.
    - **(C)** The Administrator may obtain reimbursement by the issuance of transfer and counterwarrants, or other lawful transfer documents, supported by itemized invoices, if payment is not made by a requisitioning agency within 45 days after the later of—
