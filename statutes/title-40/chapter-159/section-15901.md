---
title: "Section 15901 - State capacity building grant program"
usc_title: 40
usc_section: "15901"
chapter: 159
current_through: "PL 119-73"
classification: "40 U.S.C. § 15901"
generated_at: "2026-03-29T20:05:42.975Z"
---
...
- **(d)**
  - **(1)** Funds from a grant under a program may be used to support a project, program, or related expense of the Commission State in an eligible county.
...
- **(e)**
  - **(1)** For each fiscal year, before providing a grant under a program, each Commission State shall provide to the Commission an annual work plan that includes the proposed use of the grant.
...
- **(f)**
  - **(1)** The amount of a grant provided to a Commission State under a program for a fiscal year shall be based on the proportion that—
