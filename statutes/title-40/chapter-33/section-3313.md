---
title: "Section 3313 - Procurement of life-cycle cost effective and energy efficient lighting systems"
usc_title: 40
usc_section: "3313"
chapter: 33
current_through: "PL 118-71"
classification: "40 U.S.C. § 3313"
generated_at: "2026-03-30T01:33:15.494Z"
---
...
- **(a)** In this section:
  ...
  - **(2)** The term “lighting system” means the elements required to maintain a desired light level, including lamps, light fixtures, fixture distribution, sensors and control technologies, interior design elements, and daylighting sources.
- **(b)**
  - **(1)** To the maximum extent practicable, the Administrator shall—
  ...
  - **(2)** Each public building constructed, altered, acquired, or leased by the Administrator shall be equipped, to the maximum extent practicable as determined by the Administrator, with the most life-cycle cost effective and energy efficient lighting systems for each application.
- **(c)** Each individual component of a lighting system, including a lamp or fixture, that is replaced by the Administrator in the normal course of maintenance of public buildings shall be replaced, to the maximum extent practicable, with the most life-cycle cost effective and energy efficient lighting system possible for the application.
- **(d)**
  - **(1)** In carrying out this section, the Administrator shall consider appropriate contracting options for the procurement of the most life-cycle cost effective and energy efficient lighting systems.
  - **(2)** In making a determination under this section concerning the practicability of procuring and installing the most life-cycle cost effective and energy efficient lighting system, the Administrator shall consider—
...
- **(e)** The Administrator shall use the procedures and methods established under section 544(a) of the National Energy Conservation Policy Act ( 42 U.S.C. 8254(a) ) in determining whether a lighting system is life-cycle cost effective.
- **(f)** A lighting system shall be treated as being energy efficient for purposes of this section if—
...
- **(g)** The Administrator of the Environmental Protection Agency and the Secretary of Energy shall give priority to establishing Energy Star performance criteria or Federal Energy Management Program designations for additional lighting product categories that are appropriate for procurement and use in public buildings.
- **(h)** The Administrator shall develop guidelines for the procurement and use of energy efficient lighting technologies that contain mercury in child care centers in public buildings.
- **(i)** Acquisitions carried out pursuant to this section shall be subject to the requirements of the Buy American Act 1 1 See References in Text note below. ( 41 U.S.C. 10c et seq.).
