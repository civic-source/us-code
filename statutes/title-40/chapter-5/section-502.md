---
title: "Section 502 - Services for other entities"
usc_title: 40
usc_section: "502"
chapter: 5
...
- **(b)**
  - **(1)** On request, the Administrator may provide, to the extent practicable, any of the services specified in section 501 of this title to an agency that is—
    - **(A)**
...
- **(c)**
  - **(1)** The Administrator may provide for the use by State or local governments of Federal supply schedules of the General Services Administration for the following:
